...
fof(problem_5_123,conjecture,finer(ct1,ct2,cx) ).
fof(problem_5_124,conjecture,subset_sets(a,cx) ).
fof(problem_5_125,conjecture,~ finer(subspace_topology(cx,ct1,a),subspace_topology(cx,ct2,a),cx) ).
