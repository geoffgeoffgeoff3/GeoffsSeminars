...
fof(clause68,conjecture,actual_world(skc7) ).
fof(clause69,conjecture,chevy(skc7,skc16) ).
fof(clause70,conjecture,city(skc7,skc15) ).
fof(clause71,conjecture,lonely(skc7,skc13) ).
fof(clause72,conjecture,street(skc7,skc13) ).
fof(clause73,conjecture,group(skc7,skc8) ).
fof(clause74,conjecture,two(skc7,skc8) ).
fof(clause75,conjecture,placename(skc7,skc14) ).
fof(clause76,conjecture,hollywood_placename(skc7,skc14) ).
fof(clause77,conjecture,event(skc7,skc12) ).
fof(clause78,conjecture,present(skc7,skc12) ).
fof(clause79,conjecture,barrel(skc7,skc12) ).
fof(clause80,conjecture,white(skc7,skc16) ).
fof(clause81,conjecture,dirty(skc7,skc16) ).
fof(clause82,conjecture,old(skc7,skc16) ).
fof(clause83,conjecture,of(skc7,skc14,skc15) ).
fof(clause84,conjecture,in(skc7,skc12,skc15) ).
fof(clause85,conjecture,down(skc7,skc12,skc13) ).
fof(clause86,conjecture,agent(skc7,skc12,skc16) ).
fof(clause87,conjecture,! [U] : ( ~ member(skc7,U,skc8) | young(skc7,U) ) ).
fof(clause88,conjecture,! [U] : ( ~ member(skc7,U,skc8) | fellow(skc7,U) ) ).
fof(clause89,conjecture,! [U] : ! [V] : ( ~ member(skc7,U,skc8) | ~ frontseat(skc7,U) | state(skc7,skf6(V)) ) ).
fof(clause90,conjecture,! [U] : ( ~ member(skc7,U,skc8) | ~ frontseat(skc7,U) | in(skc7,skf5(U),U) ) ).
fof(clause91,conjecture,! [U] : ( ~ member(skc7,U,skc8) | ~ frontseat(skc7,U) | be(skc7,skf6(U),U,skf5(U)) ) ).
