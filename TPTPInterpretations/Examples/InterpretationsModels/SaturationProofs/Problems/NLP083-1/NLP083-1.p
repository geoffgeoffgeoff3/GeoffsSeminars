...
fof(clause79,conjecture,revenge(skc8,skc12) ).
fof(clause80,conjecture,male(skc8,skc11) ).
fof(clause81,conjecture,cry(skc8,skc10) ).
...
fof(clause89,conjecture,patient(skc8,skc9,skc10) ).
fof(clause90,conjecture,agent(skc8,skc9,skc11) ).
fof(clause91,conjecture,of(skc8,skc9,skc12) ).
