...
fof(clause94,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ! [X3] : ! [X4] : ! [X5] : ! [X6] : ( ~ proposition(U,V) | ~ accessible_world(U,V) | ~ think_believe_consider(U,W) | ~ present(U,W) | ~ event(U,W) | ~ theme(U,W,V) | ~ vincent_forename(U,X) | ~ forename(U,X) | ~ agent(U,W,Y) | ~ man(U,Y) | ~ of(U,X,Y) | ~ accessible_world(U,Z) | ~ proposition(U,Z) | ~ theme(U,X1,Z) | ~ event(U,X1) | ~ present(U,X1) | ~ think_believe_consider(U,X1) | ~ state(U,X2) | ~ of(U,X3,X4) | ~ vincent_forename(U,X3) | ~ forename(U,X3) | ~ man(U,X4) | ~ be(U,X2,X4,X4) | ~ agent(U,X1,X4) | ~ smoke(Z,X5) | ~ present(Z,X5) | ~ agent(Z,X5,X4) | ~ event(Z,X5) | ~ forename(U,X6) | ~ jules_forename(U,X6) | ~ of(U,X6,X4) | ~ actual_world(U) | man(V,skf4(V)) ) ).
fof(clause95,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ! [X3] : ! [X4] : ! [X5] : ! [X6] : ! [X7] : ( ~ proposition(U,V) | ~ accessible_world(U,V) | ~ smoke(V,W) | ~ present(V,W) | ~ agent(V,W,skf4(V)) | ~ event(V,W) | ~ think_believe_consider(U,X) | ~ present(U,X) | ~ event(U,X) | ~ theme(U,X,V) | ~ vincent_forename(U,Y) | ~ forename(U,Y) | ~ agent(U,X,Z) | ~ man(U,Z) | ~ of(U,Y,Z) | ~ accessible_world(U,X1) | ~ proposition(U,X1) | ~ theme(U,X2,X1) | ~ event(U,X2) | ~ present(U,X2) | ~ think_believe_consider(U,X2) | ~ state(U,X3) | ~ of(U,X4,X5) | ~ vincent_forename(U,X4) | ~ forename(U,X4) | ~ man(U,X5) | ~ be(U,X3,X5,X5) | ~ agent(U,X2,X5) | ~ smoke(X1,X6) | ~ present(X1,X6) | ~ agent(X1,X6,X5) | ~ event(X1,X6) | ~ forename(U,X7) | ~ jules_forename(U,X7) | ~ of(U,X7,X5) | ~ actual_world(U) ) ).
