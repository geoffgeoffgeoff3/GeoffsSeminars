...
fof(clause74,conjecture,frontseat(skc9,skc19) ).
fof(clause75,conjecture,chevy(skc9,skc17) ).
fof(clause76,conjecture,placename(skc9,skc16) ).
fof(clause77,conjecture,hollywood_placename(skc9,skc16) ).
fof(clause78,conjecture,city(skc9,skc15) ).
fof(clause79,conjecture,street(skc9,skc15) ).
fof(clause80,conjecture,lonely(skc9,skc15) ).
fof(clause81,conjecture,group(skc9,skc11) ).
fof(clause82,conjecture,group(skc9,skc10) ).
fof(clause83,conjecture,white(skc9,skc17) ).
fof(clause84,conjecture,dirty(skc9,skc17) ).
fof(clause85,conjecture,old(skc9,skc17) ).
fof(clause86,conjecture,barrel(skc9,skc14) ).
fof(clause87,conjecture,present(skc9,skc14) ).
fof(clause88,conjecture,event(skc9,skc14) ).
fof(clause89,conjecture,two(skc9,skc18) ).
fof(clause90,conjecture,group(skc9,skc18) ).
fof(clause91,conjecture,of(skc9,skc16,skc15) ).
fof(clause92,conjecture,down(skc9,skc14,skc15) ).
fof(clause93,conjecture,in(skc9,skc14,skc15) ).
fof(clause94,conjecture,agent(skc9,skc14,skc17) ).
...
fof(clause98,conjecture,! [U] : ( ~ member(skc9,U,skc18) | young(skc9,U) ) ).
fof(clause99,conjecture,! [U] : ( ~ member(skc9,U,skc18) | fellow(skc9,U) ) ).
fof(clause100,conjecture,! [U] : ! [V] : ( ~ member(skc9,U,skc18) | state(skc9,skf8(V)) ) ).
fof(clause101,conjecture,! [U] : ! [V] : ( ~ member(skc9,U,skc18) | in(skc9,skf7(V),skc19) ) ).
fof(clause102,conjecture,! [U] : ( ~ member(skc9,U,skc18) | be(skc9,skf8(U),U,skf7(U)) ) ).
