...
fof(clause71,conjecture,chevy(skc6,skc12) ).
fof(clause72,conjecture,white(skc6,skc12) ).
fof(clause73,conjecture,dirty(skc6,skc12) ).
fof(clause74,conjecture,old(skc6,skc12) ).
fof(clause75,conjecture,two(skc6,skc7) ).
fof(clause76,conjecture,group(skc6,skc7) ).
fof(clause77,conjecture,barrel(skc6,skc11) ).
fof(clause78,conjecture,present(skc6,skc11) ).
fof(clause79,conjecture,event(skc6,skc11) ).
fof(clause80,conjecture,lonely(skc6,skc13) ).
fof(clause81,conjecture,street(skc6,skc13) ).
fof(clause82,conjecture,city(skc6,skc13) ).
fof(clause83,conjecture,of(skc6,skc14,skc13) ).
fof(clause84,conjecture,agent(skc6,skc11,skc12) ).
fof(clause85,conjecture,in(skc6,skc11,skc13) ).
fof(clause86,conjecture,down(skc6,skc11,skc13) ).
