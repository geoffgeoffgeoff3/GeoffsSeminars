...
fof(clause79,conjecture,chevy(skc11,skc23) ).
fof(clause80,conjecture,placename(skc11,skc20) ).
fof(clause81,conjecture,hollywood_placename(skc11,skc20) ).
fof(clause82,conjecture,wheel(skc11,skc19) ).
fof(clause83,conjecture,frontseat(skc11,skc19) ).
fof(clause84,conjecture,city(skc11,skc19) ).
fof(clause85,conjecture,street(skc11,skc19) ).
fof(clause86,conjecture,lonely(skc11,skc19) ).
...
fof(clause103,conjecture,behind(skc11,skc12,skc19) ).
fof(clause104,conjecture,agent(skc11,skc18,skc23) ).
