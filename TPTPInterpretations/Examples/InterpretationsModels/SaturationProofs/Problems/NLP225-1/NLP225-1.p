...
fof(clause73,conjecture,jules_forename(skc8,skc15) ).
fof(clause74,conjecture,forename(skc8,skc15) ).
fof(clause75,conjecture,man(skc8,skc14) ).
fof(clause76,conjecture,vincent_forename(skc8,skc13) ).
fof(clause77,conjecture,forename(skc8,skc13) ).
fof(clause78,conjecture,think_believe_consider(skc8,skc12) ).
fof(clause79,conjecture,present(skc8,skc12) ).
fof(clause80,conjecture,event(skc8,skc12) ).
fof(clause81,conjecture,proposition(skc8,skc11) ).
fof(clause82,conjecture,accessible_world(skc8,skc11) ).
fof(clause83,conjecture,man(skc8,skc10) ).
fof(clause84,conjecture,state(skc8,skc9) ).
fof(clause85,conjecture,of(skc8,skc15,skc14) ).
fof(clause86,conjecture,agent(skc8,skc12,skc14) ).
fof(clause87,conjecture,of(skc8,skc13,skc14) ).
fof(clause88,conjecture,theme(skc8,skc12,skc11) ).
fof(clause89,conjecture,be(skc8,skc9,skc14,skc10) ).
fof(clause90,conjecture,! [U] : ! [V] : ( ~ man(skc11,U) | smoke(skc11,skf1(V)) ) ).
fof(clause91,conjecture,! [U] : ! [V] : ( ~ man(skc11,U) | present(skc11,skf1(V)) ) ).
fof(clause92,conjecture,! [U] : ! [V] : ( ~ man(skc11,U) | event(skc11,skf1(V)) ) ).
fof(clause93,conjecture,! [U] : ( ~ man(skc11,U) | agent(skc11,skf1(U),U) ) ).
