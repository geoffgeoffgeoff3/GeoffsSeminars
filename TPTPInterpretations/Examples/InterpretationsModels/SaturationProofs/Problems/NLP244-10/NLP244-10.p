...
fof(clause79,conjecture,event(skc15,skc23) = true ).
fof(clause80,conjecture,man(skc14,skc22) = true ).
fof(clause81,conjecture,present(skc15,skc23) = true ).
fof(clause82,conjecture,smoke(skc15,skc23) = true ).
fof(clause83,conjecture,forename(skc14,skc19) = true ).
fof(clause84,conjecture,jules_forename(skc14,skc19) = true ).
fof(clause85,conjecture,man(skc14,skc18) = true ).
...
fof(clause89,conjecture,event(skc14,skc16) = true ).
...
fof(clause95,conjecture,jules_forename(skc14,skc21) = true ).
...
fof(clause101,conjecture,of(skc14,skc21,skc22) = true ).
fof(clause102,conjecture,agent(skc15,skc23,skc22) = true ).
fof(clause103,conjecture,of(skc14,skc20,skc18) = true ).
