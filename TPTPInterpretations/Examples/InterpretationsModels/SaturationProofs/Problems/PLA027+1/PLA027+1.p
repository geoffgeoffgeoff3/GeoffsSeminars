...
fof(block_1_not_block_3,conjecture,different(block_1,block_3) ).
fof(block_1_not_block_4,conjecture,different(block_1,block_4) ).
fof(block_2_not_block_3,conjecture,different(block_2,block_3) ).
fof(block_2_not_block_4,conjecture,different(block_2,block_4) ).
fof(block_3_not_block_4,conjecture,different(block_3,block_4) ).
fof(block_1_not_table,conjecture,different(block_1,table) ).
fof(block_2_not_table,conjecture,different(block_2,table) ).
fof(block_3_not_table,conjecture,different(block_3,table) ).
fof(block_4_not_table,conjecture,different(block_4,table) ).
fof(block_1,conjecture,a_block(block_1) ).
fof(block_2,conjecture,a_block(block_2) ).
fof(block_3,conjecture,a_block(block_3) ).
fof(block_4,conjecture,a_block(block_4) ).
...
fof(nonfixed_block_3,conjecture,nonfixed(block_3) ).
fof(nonfixed_block_4,conjecture,nonfixed(block_4) ).
fof(time_0,conjecture,time(time_0) ).
fof(time_1,conjecture,time(s(time_0)) ).
fof(time_2,conjecture,time(s(s(time_0))) ).
fof(time_3,conjecture,time(s(s(s(time_0)))) ).
fof(time_4,conjecture,time(s(s(s(s(time_0))))) ).
...
fof(initial_1_on_2,conjecture,on(block_1,block_2,time_0) ).
fof(initial_clear_1,conjecture,clear(block_1,time_0) ).
fof(initial_2_on_3,conjecture,on(block_2,block_3,time_0) ).
fof(initial_3_on_4,conjecture,on(block_3,block_4,time_0) ).
fof(initial_4_on_table,conjecture,on(block_4,table,time_0) ).
fof(goal_time_4,conjecture,goal_time(s(s(s(s(time_0))))) ).
