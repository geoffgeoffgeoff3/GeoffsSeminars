...
fof(clause36,conjecture,restaurant(skc3,skc5) ).
fof(clause37,conjecture,coffee(skc3,skc4) ).
fof(clause38,conjecture,! [U] : ! [V] : ( ~ in(skc3,U,skc5) | ~ customer(skc3,U) | see(skc3,skf3(V)) ) ).
fof(clause39,conjecture,! [U] : ! [V] : ( ~ in(skc3,U,skc5) | ~ customer(skc3,U) | nonreflexive(skc3,skf3(V)) ) ).
fof(clause40,conjecture,! [U] : ! [V] : ( ~ in(skc3,U,skc5) | ~ customer(skc3,U) | past(skc3,skf3(V)) ) ).
fof(clause41,conjecture,! [U] : ! [V] : ( ~ in(skc3,U,skc5) | ~ customer(skc3,U) | event(skc3,skf3(V)) ) ).
fof(clause42,conjecture,! [U] : ! [V] : ( ~ in(skc3,U,skc5) | ~ customer(skc3,U) | event(skc3,skf4(V)) ) ).
fof(clause43,conjecture,! [U] : ! [V] : ( ~ in(skc3,U,skc5) | ~ customer(skc3,U) | past(skc3,skf4(V)) ) ).
fof(clause44,conjecture,! [U] : ! [V] : ( ~ in(skc3,U,skc5) | ~ customer(skc3,U) | nonreflexive(skc3,skf4(V)) ) ).
fof(clause45,conjecture,! [U] : ! [V] : ( ~ in(skc3,U,skc5) | ~ customer(skc3,U) | drink(skc3,skf4(V)) ) ).
fof(clause46,conjecture,! [U] : ! [V] : ( ~ in(skc3,U,skc5) | ~ customer(skc3,U) | human_person(skc3,skf5(V)) ) ).
fof(clause47,conjecture,! [U] : ( ~ in(skc3,U,skc5) | ~ customer(skc3,U) | agent(skc3,skf3(U),U) ) ).
fof(clause48,conjecture,! [U] : ! [V] : ( ~ in(skc3,U,skc5) | ~ customer(skc3,U) | patient(skc3,skf4(V),skc4) ) ).
fof(clause49,conjecture,! [U] : ! [V] : ( ~ in(skc3,U,skc5) | ~ customer(skc3,U) | patient(skc3,skf3(V),skf5(V)) ) ).
fof(clause50,conjecture,! [U] : ! [V] : ( ~ in(skc3,U,skc5) | ~ customer(skc3,U) | agent(skc3,skf4(V),skf5(V)) ) ).
