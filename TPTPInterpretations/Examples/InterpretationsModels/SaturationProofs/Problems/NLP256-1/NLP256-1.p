...
fof(clause94,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ! [X3] : ! [X4] : ! [X5] : ! [X6] : ! [X7] : ( ~ accessible_world(U,V) | ~ proposition(U,V) | ~ proposition(U,W) | ~ accessible_world(U,W) | ~ think_believe_consider(U,X) | ~ present(U,X) | ~ event(U,X) | ~ theme(U,X,W) | ~ vincent_forename(U,Y) | ~ forename(U,Y) | ~ forename(U,Z) | ~ jules_forename(U,Z) | ~ of(U,Z,X1) | ~ smoke(V,X2) | ~ present(V,X2) | ~ agent(V,X2,X1) | ~ event(V,X2) | ~ agent(U,X,X1) | ~ man(U,X1) | ~ of(U,Y,X1) | ~ theme(U,X3,V) | ~ event(U,X3) | ~ present(U,X3) | ~ think_believe_consider(U,X3) | ~ state(U,X4) | ~ of(U,X5,X6) | ~ vincent_forename(U,X5) | ~ forename(U,X5) | ~ man(U,X6) | ~ be(U,X4,X6,X6) | ~ agent(U,X3,X6) | ~ forename(U,X7) | ~ jules_forename(U,X7) | ~ of(U,X7,X6) | ~ actual_world(U) | man(W,skf4(W)) ) ).
fof(clause95,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ! [X3] : ! [X4] : ! [X5] : ! [X6] : ! [X7] : ! [X8] : ( ~ accessible_world(U,V) | ~ proposition(U,V) | ~ proposition(U,W) | ~ accessible_world(U,W) | ~ smoke(W,X) | ~ present(W,X) | ~ agent(W,X,skf4(W)) | ~ event(W,X) | ~ think_believe_consider(U,Y) | ~ present(U,Y) | ~ event(U,Y) | ~ theme(U,Y,W) | ~ vincent_forename(U,Z) | ~ forename(U,Z) | ~ forename(U,X1) | ~ jules_forename(U,X1) | ~ of(U,X1,X2) | ~ smoke(V,X3) | ~ present(V,X3) | ~ agent(V,X3,X2) | ~ event(V,X3) | ~ agent(U,Y,X2) | ~ man(U,X2) | ~ of(U,Z,X2) | ~ theme(U,X4,V) | ~ event(U,X4) | ~ present(U,X4) | ~ think_believe_consider(U,X4) | ~ state(U,X5) | ~ of(U,X6,X7) | ~ vincent_forename(U,X6) | ~ forename(U,X6) | ~ man(U,X7) | ~ be(U,X5,X7,X7) | ~ agent(U,X4,X7) | ~ forename(U,X8) | ~ jules_forename(U,X8) | ~ of(U,X8,X7) | ~ actual_world(U) ) ).
