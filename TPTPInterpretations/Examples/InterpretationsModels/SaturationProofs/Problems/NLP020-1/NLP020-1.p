...
fof(clause48,conjecture,city(skc11) ).
fof(clause49,conjecture,hollywood(skc11) ).
fof(clause50,conjecture,event(skc10) ).
fof(clause51,conjecture,lonely(skc9) ).
fof(clause52,conjecture,way(skc9) ).
fof(clause53,conjecture,street(skc9) ).
fof(clause54,conjecture,seat(skc7) ).
fof(clause55,conjecture,furniture(skc7) ).
fof(clause56,conjecture,front(skc7) ).
fof(clause57,conjecture,young(skc6) ).
fof(clause58,conjecture,man(skc6) ).
fof(clause59,conjecture,fellow(skc6) ).
fof(clause60,conjecture,chevy(skc8) ).
fof(clause61,conjecture,car(skc8) ).
fof(clause62,conjecture,white(skc8) ).
fof(clause63,conjecture,dirty(skc8) ).
fof(clause64,conjecture,old(skc8) ).
fof(clause65,conjecture,in(skc10,skc11) ).
fof(clause66,conjecture,barrel(skc10,skc8) ).
fof(clause67,conjecture,down(skc10,skc9) ).
fof(clause68,conjecture,in(skc6,skc7) ).
