...
fof(clause73,conjecture,actual_world(skc8) ).
fof(clause74,conjecture,placename(skc8,skc19) ).
fof(clause75,conjecture,hollywood_placename(skc8,skc19) ).
fof(clause76,conjecture,lonely(skc8,skc15) ).
fof(clause77,conjecture,street(skc8,skc15) ).
fof(clause78,conjecture,frontseat(skc8,skc15) ).
fof(clause79,conjecture,event(skc8,skc14) ).
fof(clause80,conjecture,present(skc8,skc14) ).
fof(clause81,conjecture,barrel(skc8,skc14) ).
fof(clause82,conjecture,city(skc8,skc18) ).
fof(clause83,conjecture,chevy(skc8,skc18) ).
fof(clause84,conjecture,white(skc8,skc18) ).
fof(clause85,conjecture,dirty(skc8,skc18) ).
fof(clause86,conjecture,old(skc8,skc18) ).
fof(clause87,conjecture,group(skc8,skc10) ).
fof(clause88,conjecture,group(skc8,skc9) ).
fof(clause89,conjecture,group(skc8,skc13) ).
fof(clause90,conjecture,two(skc8,skc13) ).
fof(clause91,conjecture,of(skc8,skc19,skc18) ).
fof(clause92,conjecture,down(skc8,skc14,skc15) ).
fof(clause93,conjecture,agent(skc8,skc14,skc18) ).
fof(clause94,conjecture,in(skc8,skc14,skc18) ).
fof(clause95,conjecture,! [U] : ( ~ member(skc8,U,skc9) | cheap(skc8,U) ) ).
fof(clause96,conjecture,! [U] : ( ~ member(skc8,U,skc9) | black(skc8,U) ) ).
fof(clause97,conjecture,! [U] : ( ~ member(skc8,U,skc9) | coat(skc8,U) ) ).
fof(clause98,conjecture,! [U] : ( ~ member(skc8,U,skc13) | young(skc8,U) ) ).
fof(clause99,conjecture,! [U] : ( ~ member(skc8,U,skc13) | fellow(skc8,U) ) ).
fof(clause100,conjecture,! [U] : ! [V] : ( ~ member(skc8,U,skc13) | state(skc8,skf8(V)) ) ).
fof(clause101,conjecture,! [U] : ! [V] : ( ~ member(skc8,U,skc13) | in(skc8,skf7(V),skc15) ) ).
fof(clause102,conjecture,! [U] : ( ~ member(skc8,U,skc13) | be(skc8,skf8(U),U,skf7(U)) ) ).
fof(clause103,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc8,U,skc10) | ~ member(skc8,V,skc9) | event(skc8,skf6(W,X)) ) ).
fof(clause104,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc8,U,skc10) | ~ member(skc8,V,skc9) | present(skc8,skf6(W,X)) ) ).
fof(clause105,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc8,U,skc10) | ~ member(skc8,V,skc9) | nonreflexive(skc8,skf6(W,X)) ) ).
fof(clause106,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc8,U,skc10) | ~ member(skc8,V,skc9) | wear(skc8,skf6(W,X)) ) ).
fof(clause107,conjecture,! [U] : ! [V] : ! [W] : ( ~ member(skc8,U,skc10) | ~ member(skc8,V,skc9) | agent(skc8,skf6(U,W),U) ) ).
fof(clause108,conjecture,! [U] : ! [V] : ( ~ member(skc8,U,skc10) | ~ member(skc8,V,skc9) | patient(skc8,skf6(U,V),V) ) ).
