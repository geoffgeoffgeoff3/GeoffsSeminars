...
fof(clause75,conjecture,frontseat(skc9,skc18) ).
...
fof(clause79,conjecture,placename(skc9,skc17) ).
...
fof(clause92,conjecture,in(skc9,skc15,skc18) ).
fof(clause93,conjecture,of(skc9,skc17,skc18) ).
...
fof(clause101,conjecture,! [U] : ! [V] : ( ~ member(skc9,U,skc14) | in(skc9,skf7(V),skc18) ) ).
