...
fof(clause88,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ( ~ state(U,V) | ~ man(U,W) | ~ accessible_world(U,X) | ~ proposition(U,X) | ~ theme(U,Y,X) | ~ event(U,Y) | ~ present(U,Y) | ~ think_believe_consider(U,Y) | ~ forename(U,Z) | ~ vincent_forename(U,Z) | ~ of(U,Z,X1) | ~ man(U,X1) | ~ agent(U,Y,X1) | ~ be(U,V,X1,W) | ~ forename(U,X2) | ~ jules_forename(U,X2) | ~ of(U,X2,X1) | ~ actual_world(U) | man(X,skf4(X)) ) ).
fof(clause89,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ! [X3] : ( ~ state(U,V) | ~ man(U,W) | ~ smoke(X,Y) | ~ present(X,Y) | ~ agent(X,Y,skf4(X)) | ~ event(X,Y) | ~ accessible_world(U,X) | ~ proposition(U,X) | ~ theme(U,Z,X) | ~ event(U,Z) | ~ present(U,Z) | ~ think_believe_consider(U,Z) | ~ forename(U,X1) | ~ vincent_forename(U,X1) | ~ of(U,X1,X2) | ~ man(U,X2) | ~ agent(U,Z,X2) | ~ be(U,V,X2,W) | ~ forename(U,X3) | ~ jules_forename(U,X3) | ~ of(U,X3,X2) | ~ actual_world(U) ) ).
