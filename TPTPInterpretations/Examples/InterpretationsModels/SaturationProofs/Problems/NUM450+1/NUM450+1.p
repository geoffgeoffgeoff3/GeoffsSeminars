...
fof(m__2144,conjecture,isClosed0(sbsmnsldt0(xS)) & isOpen0(stldt0(sbsmnsldt0(xS))) ).
fof(m__,conjecture,~(? [W0] : ( aInteger0(W0) & W0 != sz00 & aSubsetOf0(szAzrzSzezqlpdtcmdtrp0(sz10,W0),stldt0(sbsmnsldt0(xS))) ) )).
