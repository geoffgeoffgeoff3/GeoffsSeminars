...
fof(clause5,conjecture,ssSkC0 | nonhuman(skc33,skc37) ).
fof(clause6,conjecture,ssSkC0 | mia_forename(skc33,skc37) ).
fof(clause7,conjecture,ssSkC0 | forename(skc33,skc37) ).
fof(clause8,conjecture,ssSkC0 | woman(skc33,skc38) ).
fof(clause9,conjecture,ssSkC0 | event(skc33,skc35) ).
fof(clause10,conjecture,ssSkC0 | past(skc33,skc35) ).
fof(clause11,conjecture,ssSkC0 | nonreflexive(skc33,skc35) ).
fof(clause12,conjecture,ssSkC0 | order(skc33,skc35) ).
fof(clause13,conjecture,ssSkC0 | shake_beverage(skc33,skc36) ).
...
fof(clause25,conjecture,ssSkC0 | ssSkP0(skc37,skc34,skc33) ).
fof(clause26,conjecture,ssSkC0 | agent(skc33,skc35,skc38) ).
fof(clause27,conjecture,ssSkC0 | of(skc33,skc37,skc38) ).
...
fof(clause46,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ( ~ dollar(U,skf5(U,V)) | ~ group(U,W) | ~ five(U,W) | ~ nonhuman(U,X) | ~ mia_forename(U,X) | ~ forename(U,X) | ~ ssSkP0(X,W,U) | ~ agent(U,Y,Z) | ~ woman(U,Z) | ~ of(U,X,Z) | ~ event(U,Y) | ~ past(U,Y) | ~ nonreflexive(U,Y) | ~ order(U,Y) | ~ patient(U,Y,X1) | ~ shake_beverage(U,X1) | ~ actual_world(U) | ~ ssSkC0 ) ).
