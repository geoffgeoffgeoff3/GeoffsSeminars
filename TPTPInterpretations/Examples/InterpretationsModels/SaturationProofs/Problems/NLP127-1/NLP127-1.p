...
fof(clause37,conjecture,chevy(skc6,skc11) ).
fof(clause38,conjecture,city(skc6,skc10) ).
fof(clause39,conjecture,lonely(skc6,skc8) ).
fof(clause40,conjecture,street(skc6,skc8) ).
fof(clause41,conjecture,placename(skc6,skc9) ).
fof(clause42,conjecture,hollywood_placename(skc6,skc9) ).
fof(clause43,conjecture,event(skc6,skc7) ).
fof(clause44,conjecture,present(skc6,skc7) ).
fof(clause45,conjecture,barrel(skc6,skc7) ).
fof(clause46,conjecture,white(skc6,skc11) ).
fof(clause47,conjecture,dirty(skc6,skc11) ).
fof(clause48,conjecture,old(skc6,skc11) ).
fof(clause49,conjecture,of(skc6,skc9,skc10) ).
fof(clause50,conjecture,in(skc6,skc7,skc10) ).
fof(clause51,conjecture,down(skc6,skc7,skc8) ).
fof(clause52,conjecture,agent(skc6,skc7,skc11) ).
