...
fof(clause74,conjecture,hollywood_placename(skc7,skc12) ).
fof(clause75,conjecture,placename(skc7,skc12) ).
fof(clause76,conjecture,lonely(skc7,skc11) ).
fof(clause77,conjecture,street(skc7,skc11) ).
fof(clause78,conjecture,city(skc7,skc11) ).
fof(clause79,conjecture,frontseat(skc7,skc9) ).
fof(clause80,conjecture,ssSkP0(skc8,skc7) ).
fof(clause81,conjecture,group(skc7,skc8) ).
fof(clause82,conjecture,two(skc7,skc8) ).
fof(clause83,conjecture,old(skc7,skc13) ).
fof(clause84,conjecture,dirty(skc7,skc13) ).
fof(clause85,conjecture,white(skc7,skc13) ).
fof(clause86,conjecture,chevy(skc7,skc13) ).
fof(clause87,conjecture,event(skc7,skc10) ).
fof(clause88,conjecture,present(skc7,skc10) ).
fof(clause89,conjecture,barrel(skc7,skc10) ).
fof(clause90,conjecture,agent(skc7,skc10,skc13) ).
fof(clause91,conjecture,of(skc7,skc12,skc11) ).
fof(clause92,conjecture,in(skc7,skc10,skc11) ).
fof(clause93,conjecture,down(skc7,skc10,skc11) ).
fof(clause94,conjecture,ssSkP1(skc9,skc8,skc7) ).
...
fof(clause107,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ! [X3] : ( ~ ssSkP0(U,V) | ~ group(V,U) | ~ two(V,U) | ~ frontseat(V,W) | ~ ssSkP1(W,U,V) | ~ event(V,X) | ~ present(V,X) | ~ barrel(V,X) | ~ agent(V,X,Y) | ~ old(V,Y) | ~ dirty(V,Y) | ~ white(V,Y) | ~ chevy(V,Y) | ~ in(V,X,Z) | ~ down(V,X,Z) | ~ lonely(V,Z) | ~ street(V,Z) | ~ city(V,Z) | ~ of(V,X1,Z) | ~ hollywood_placename(V,X1) | ~ placename(V,X1) | ~ group(V,X2) | ~ ssSkP2(X3,X2,V) | ~ group(V,X3) | ~ actual_world(V) | member(V,skf10(V,X2),X2) ) ).
fof(clause108,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ! [X3] : ! [X4] : ( ~ ssSkP0(U,V) | ~ group(V,U) | ~ two(V,U) | ~ frontseat(V,W) | ~ ssSkP1(W,U,V) | ~ event(V,X) | ~ present(V,X) | ~ barrel(V,X) | ~ agent(V,X,Y) | ~ old(V,Y) | ~ dirty(V,Y) | ~ white(V,Y) | ~ chevy(V,Y) | ~ in(V,X,Z) | ~ down(V,X,Z) | ~ lonely(V,Z) | ~ street(V,Z) | ~ city(V,Z) | ~ of(V,X1,Z) | ~ hollywood_placename(V,X1) | ~ placename(V,X1) | ~ group(V,X2) | ~ cheap(V,skf10(V,X3)) | ~ black(V,skf10(V,X3)) | ~ coat(V,skf10(V,X3)) | ~ ssSkP2(X4,X2,V) | ~ group(V,X4) | ~ actual_world(V) ) ).
