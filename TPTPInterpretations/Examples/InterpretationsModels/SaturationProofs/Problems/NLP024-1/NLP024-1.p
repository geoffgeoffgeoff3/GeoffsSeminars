...
fof(clause74,conjecture,actual_world(skc8) ).
fof(clause75,conjecture,man(skc8,skc15) ).
fof(clause76,conjecture,event(skc10,skc13) ).
fof(clause77,conjecture,woman(skc8,skc12) ).
fof(clause78,conjecture,present(skc10,skc13) ).
fof(clause79,conjecture,dance(skc10,skc13) ).
fof(clause80,conjecture,forename(skc8,skc11) ).
fof(clause81,conjecture,mia_forename(skc8,skc11) ).
fof(clause82,conjecture,proposition(skc8,skc10) ).
fof(clause83,conjecture,accessible_world(skc8,skc10) ).
fof(clause84,conjecture,desire_want(skc8,skc9) ).
fof(clause85,conjecture,present(skc8,skc9) ).
fof(clause86,conjecture,forename(skc8,skc14) ).
fof(clause87,conjecture,vincent_forename(skc8,skc14) ).
fof(clause88,conjecture,of(skc8,skc14,skc15) ).
fof(clause89,conjecture,of(skc8,skc11,skc12) ).
fof(clause90,conjecture,agent(skc8,skc9,skc12) ).
fof(clause91,conjecture,agent(skc10,skc13,skc12) ).
fof(clause92,conjecture,theme(skc8,skc9,skc10) ).
fof(clause93,conjecture,! [U] : ! [V] : ! [W] : ( ~ present(skc8,U) | ~ desire_want(skc8,U) | ~ agent(skc8,U,skc15) | ~ dance(V,W) | ~ present(V,W) | ~ agent(V,W,skc15) | ~ event(V,W) | ~ accessible_world(skc8,V) | ~ theme(skc8,U,V) | ~ proposition(skc8,V) ) ).
