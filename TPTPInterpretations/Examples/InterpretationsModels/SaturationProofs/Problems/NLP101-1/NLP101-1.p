...
fof(clause25,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc6,U) | ~ in(skc6,V,U) | ~ customer(skc6,V) | ~ ssSkC0 | human_person(skc6,skf11(W)) ) ).
...
fof(clause30,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc6,U) | ~ in(skc6,V,U) | ~ customer(skc6,V) | ~ ssSkC0 | coffee(skc6,skf10(W)) ) ).
...
fof(clause33,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc6,U) | ~ in(skc6,V,U) | ~ customer(skc6,V) | ~ ssSkC0 | patient(skc6,skf9(W),skf10(W)) ) ).
fof(clause34,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc6,U) | ~ in(skc6,V,U) | ~ customer(skc6,V) | ~ ssSkC0 | patient(skc6,skf8(W),skf11(W)) ) ).
...
fof(clause37,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ( ~ event(U,V) | ~ agent(U,V,skf27(U)) | ~ past(U,V) | ~ nonreflexive(U,V) | ~ see(U,V) | ~ patient(U,V,W) | ~ agent(U,X,W) | ~ human_person(U,W) | ~ drink(U,X) | ~ nonreflexive(U,X) | ~ past(U,X) | ~ event(U,X) | ~ coffee(U,Y) | ~ patient(U,X,Y) | ~ actual_world(U) | ssSkC0 ) ).
