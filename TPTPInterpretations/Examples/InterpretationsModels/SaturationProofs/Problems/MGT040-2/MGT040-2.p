...
fof(mp_selection_favours_in_time_33,conjecture,! [A] : ! [B] : ( ~ environment(A) | ~ greater_or_equal(B,appear(efficient_producers,A)) | ~ greater(critical_point(A),B) | in_environment(A,critical_point(A)) | selection_favors(first_movers,efficient_producers,end_time(A)) ) ).
...
fof(prove_t9_39,conjecture,observational_period(sk2) ).
fof(prove_t9_40,conjecture,rapid_change(sk2) ).
fof(prove_t9_41,conjecture,~ extreme(sk2) ).
fof(prove_t9_42,conjecture,~ selection_favors(first_movers,efficient_producers,sk2) ).
