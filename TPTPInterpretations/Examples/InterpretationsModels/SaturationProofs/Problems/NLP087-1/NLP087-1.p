...
fof(clause79,conjecture,cry(skc7,skc9) ).
fof(clause80,conjecture,six(skc7,skc10) ).
fof(clause81,conjecture,group(skc7,skc10) ).
fof(clause82,conjecture,scream(skc7,skc8) ).
fof(clause83,conjecture,nonreflexive(skc7,skc8) ).
fof(clause84,conjecture,present(skc7,skc8) ).
fof(clause85,conjecture,event(skc7,skc8) ).
fof(clause86,conjecture,revenge(skc7,skc14) ).
fof(clause87,conjecture,of(skc7,skc8,skc14) ).
fof(clause88,conjecture,of(skc7,skc11,skc12) ).
fof(clause89,conjecture,agent(skc7,skc8,skc12) ).
fof(clause90,conjecture,patient(skc7,skc8,skc9) ).
fof(clause91,conjecture,! [U] : ( ~ member(skc7,U,skc10) | shot(skc7,U) ) ).
fof(clause92,conjecture,! [U] : ! [V] : ( ~ member(skc7,U,skc10) | fire(skc7,skf8(V)) ) ).
fof(clause93,conjecture,! [U] : ! [V] : ( ~ member(skc7,U,skc10) | nonreflexive(skc7,skf8(V)) ) ).
fof(clause94,conjecture,! [U] : ! [V] : ( ~ member(skc7,U,skc10) | present(skc7,skf8(V)) ) ).
fof(clause95,conjecture,! [U] : ! [V] : ( ~ member(skc7,U,skc10) | event(skc7,skf8(V)) ) ).
fof(clause96,conjecture,! [U] : ! [V] : ( ~ member(skc7,U,skc10) | from_loc(skc7,skf8(V),skc11) ) ).
fof(clause97,conjecture,! [U] : ( ~ member(skc7,U,skc10) | patient(skc7,skf8(U),U) ) ).
fof(clause98,conjecture,! [U] : ! [V] : ( ~ member(skc7,U,skc10) | agent(skc7,skf8(V),skc12) ) ).
