...
fof(clause4,conjecture,ssSkC0 | present(skc17,skc18) ).
fof(clause5,conjecture,ssSkC0 | barrel(skc17,skc18) ).
fof(clause6,conjecture,ssSkC0 | lonely(skc17,skc21) ).
fof(clause7,conjecture,ssSkC0 | street(skc17,skc21) ).
fof(clause8,conjecture,ssSkC0 | old(skc17,skc19) ).
fof(clause9,conjecture,ssSkC0 | dirty(skc17,skc19) ).
fof(clause10,conjecture,ssSkC0 | white(skc17,skc19) ).
fof(clause11,conjecture,ssSkC0 | chevy(skc17,skc19) ).
fof(clause12,conjecture,ssSkC0 | city(skc17,skc19) ).
fof(clause13,conjecture,ssSkC0 | hollywood_placename(skc17,skc20) ).
fof(clause14,conjecture,ssSkC0 | placename(skc17,skc20) ).
...
fof(clause27,conjecture,ssSkC0 | down(skc17,skc18,skc21) ).
fof(clause28,conjecture,ssSkC0 | in(skc17,skc18,skc19) ).
fof(clause29,conjecture,ssSkC0 | agent(skc17,skc18,skc19) ).
fof(clause30,conjecture,ssSkC0 | of(skc17,skc20,skc19) ).
