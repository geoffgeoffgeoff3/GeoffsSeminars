...
fof(problem_11_151,conjecture,topological_space(cx,ct) ).
fof(problem_11_152,conjecture,subset_sets(a,cx) ).
fof(problem_11_153,conjecture,~ equal_sets(union_of_sets(interior(a,cx,ct),boundary(a,cx,ct)),closure(a,cx,ct)) ).
