...
fof(clause84,conjecture,frontseat(skc12,skc21) ).
fof(clause85,conjecture,old(skc12,skc25) ).
fof(clause86,conjecture,dirty(skc12,skc25) ).
fof(clause87,conjecture,white(skc12,skc25) ).
fof(clause88,conjecture,chevy(skc12,skc25) ).
...
fof(clause100,conjecture,agent(skc12,skc20,skc25) ).
fof(clause101,conjecture,of(skc12,skc22,skc21) ).
fof(clause102,conjecture,in(skc12,skc20,skc21) ).
fof(clause103,conjecture,down(skc12,skc20,skc21) ).
