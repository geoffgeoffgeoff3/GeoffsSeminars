...
fof(clause75,conjecture,actual_world(skc8) ).
fof(clause76,conjecture,man(skc8,skc15) ).
fof(clause77,conjecture,male(skc8,skc15) ).
fof(clause78,conjecture,cannon(skc8,skc14) ).
fof(clause79,conjecture,cry(skc8,skc12) ).
fof(clause80,conjecture,male(skc8,skc11) ).
fof(clause81,conjecture,revenge(skc8,skc10) ).
fof(clause82,conjecture,event(skc8,skc9) ).
fof(clause83,conjecture,present(skc8,skc9) ).
fof(clause84,conjecture,nonreflexive(skc8,skc9) ).
fof(clause85,conjecture,scream(skc8,skc9) ).
fof(clause86,conjecture,group(skc8,skc13) ).
fof(clause87,conjecture,six(skc8,skc13) ).
fof(clause88,conjecture,of(skc8,skc14,skc15) ).
fof(clause89,conjecture,of(skc8,skc9,skc10) ).
fof(clause90,conjecture,agent(skc8,skc9,skc11) ).
fof(clause91,conjecture,patient(skc8,skc9,skc12) ).
fof(clause92,conjecture,! [U] : ( ~ member(skc8,U,skc13) | shot(skc8,U) ) ).
fof(clause93,conjecture,! [U] : ! [V] : ( ~ member(skc8,U,skc13) | fire(skc8,skf8(V)) ) ).
fof(clause94,conjecture,! [U] : ! [V] : ( ~ member(skc8,U,skc13) | nonreflexive(skc8,skf8(V)) ) ).
fof(clause95,conjecture,! [U] : ! [V] : ( ~ member(skc8,U,skc13) | present(skc8,skf8(V)) ) ).
fof(clause96,conjecture,! [U] : ! [V] : ( ~ member(skc8,U,skc13) | event(skc8,skf8(V)) ) ).
fof(clause97,conjecture,! [U] : ! [V] : ( ~ member(skc8,U,skc13) | from_loc(skc8,skf8(V),skc14) ) ).
fof(clause98,conjecture,! [U] : ( ~ member(skc8,U,skc13) | patient(skc8,skf8(U),U) ) ).
fof(clause99,conjecture,! [U] : ! [V] : ( ~ member(skc8,U,skc13) | agent(skc8,skf8(V),skc15) ) ).
