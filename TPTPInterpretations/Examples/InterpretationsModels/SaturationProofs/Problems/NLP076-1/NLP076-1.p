...
fof(clause75,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ of(skc2,U,skc3) | ~ cannon(skc2,U) | ~ member(skc2,U,skc3) | ~ man(skc2,V) | event(skc2,skf8(W,X)) ) ).
fof(clause76,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ of(skc2,U,skc3) | ~ cannon(skc2,U) | ~ member(skc2,U,skc3) | ~ man(skc2,V) | present(skc2,skf8(W,X)) ) ).
fof(clause77,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ of(skc2,U,skc3) | ~ cannon(skc2,U) | ~ member(skc2,U,skc3) | ~ man(skc2,V) | nonreflexive(skc2,skf8(W,X)) ) ).
fof(clause78,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ of(skc2,U,skc3) | ~ cannon(skc2,U) | ~ member(skc2,U,skc3) | ~ man(skc2,V) | fire(skc2,skf8(W,X)) ) ).
fof(clause79,conjecture,! [U] : ! [V] : ( ~ of(skc2,U,skc3) | ~ cannon(skc2,U) | ~ member(skc2,U,skc3) | ~ man(skc2,V) | patient(skc2,skf8(V,U),U) ) ).
fof(clause80,conjecture,! [U] : ! [V] : ( ~ of(skc2,U,skc3) | ~ cannon(skc2,U) | ~ member(skc2,U,skc3) | ~ man(skc2,V) | from_loc(skc2,skf8(V,U),U) ) ).
fof(clause81,conjecture,! [U] : ! [V] : ! [W] : ( ~ of(skc2,U,skc3) | ~ cannon(skc2,U) | ~ member(skc2,U,skc3) | ~ man(skc2,V) | agent(skc2,skf8(V,W),V) ) ).
