...
fof(clause79,conjecture,woman(skc7,skc14) ).
fof(clause80,conjecture,shake_beverage(skc7,skc12) ).
fof(clause81,conjecture,nonhuman(skc7,skc9) ).
fof(clause82,conjecture,group(skc7,skc8) ).
fof(clause83,conjecture,five(skc7,skc8) ).
fof(clause84,conjecture,event(skc7,skc11) ).
fof(clause85,conjecture,past(skc7,skc11) ).
fof(clause86,conjecture,nonreflexive(skc7,skc11) ).
fof(clause87,conjecture,order(skc7,skc11) ).
fof(clause88,conjecture,mia_forename(skc7,skc13) ).
fof(clause89,conjecture,forename(skc7,skc13) ).
fof(clause90,conjecture,agent(skc7,skc11,skc14) ).
fof(clause91,conjecture,of(skc7,skc13,skc14) ).
fof(clause92,conjecture,patient(skc7,skc11,skc12) ).
fof(clause93,conjecture,! [U] : ( ~ member(skc7,U,skc8) | dollar(skc7,U) ) ).
fof(clause94,conjecture,! [U] : ! [V] : ( ~ member(skc7,U,skc8) | cost(skc7,skf7(V)) ) ).
fof(clause95,conjecture,! [U] : ! [V] : ( ~ member(skc7,U,skc8) | nonreflexive(skc7,skf7(V)) ) ).
fof(clause96,conjecture,! [U] : ! [V] : ( ~ member(skc7,U,skc8) | present(skc7,skf7(V)) ) ).
fof(clause97,conjecture,! [U] : ! [V] : ( ~ member(skc7,U,skc8) | event(skc7,skf7(V)) ) ).
fof(clause98,conjecture,! [U] : ( ~ member(skc7,U,skc8) | patient(skc7,skf7(U),U) ) ).
fof(clause99,conjecture,! [U] : ! [V] : ( ~ member(skc7,U,skc8) | agent(skc7,skf7(V),skc9) ) ).
