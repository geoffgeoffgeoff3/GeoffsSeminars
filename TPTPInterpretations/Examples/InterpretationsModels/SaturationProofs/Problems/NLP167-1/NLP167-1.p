...
fof(clause24,conjecture,~ ssSkC0 | frontseat(skc17,skc25) ).
fof(clause25,conjecture,~ ssSkC0 | chevy(skc17,skc25) ).
fof(clause26,conjecture,~ ssSkC0 | white(skc17,skc25) ).
fof(clause27,conjecture,~ ssSkC0 | dirty(skc17,skc25) ).
fof(clause28,conjecture,~ ssSkC0 | old(skc17,skc25) ).
fof(clause29,conjecture,~ ssSkC0 | event(skc17,skc21) ).
fof(clause30,conjecture,~ ssSkC0 | present(skc17,skc21) ).
fof(clause31,conjecture,~ ssSkC0 | barrel(skc17,skc21) ).
fof(clause32,conjecture,~ ssSkC0 | placename(skc17,skc23) ).
fof(clause33,conjecture,~ ssSkC0 | hollywood_placename(skc17,skc23) ).
fof(clause34,conjecture,~ ssSkC0 | city(skc17,skc24) ).
fof(clause35,conjecture,~ ssSkC0 | lonely(skc17,skc22) ).
fof(clause36,conjecture,~ ssSkC0 | street(skc17,skc22) ).
...
fof(clause46,conjecture,~ ssSkC0 | ssSkP1(skc25,skc20,skc17) ).
fof(clause47,conjecture,~ ssSkC0 | of(skc17,skc23,skc24) ).
fof(clause48,conjecture,~ ssSkC0 | in(skc17,skc21,skc24) ).
