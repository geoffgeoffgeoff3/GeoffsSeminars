...
fof(clause24,conjecture,~ ssSkC0 | frontseat(skc18,skc26) ).
fof(clause25,conjecture,~ ssSkC0 | chevy(skc18,skc26) ).
fof(clause26,conjecture,~ ssSkC0 | white(skc18,skc26) ).
fof(clause27,conjecture,~ ssSkC0 | dirty(skc18,skc26) ).
fof(clause28,conjecture,~ ssSkC0 | old(skc18,skc26) ).
fof(clause29,conjecture,~ ssSkC0 | event(skc18,skc22) ).
fof(clause30,conjecture,~ ssSkC0 | present(skc18,skc22) ).
fof(clause31,conjecture,~ ssSkC0 | barrel(skc18,skc22) ).
fof(clause32,conjecture,~ ssSkC0 | placename(skc18,skc24) ).
fof(clause33,conjecture,~ ssSkC0 | hollywood_placename(skc18,skc24) ).
...
fof(clause46,conjecture,~ ssSkC0 | ssSkP1(skc26,skc21,skc18) ).
fof(clause47,conjecture,~ ssSkC0 | of(skc18,skc24,skc25) ).
fof(clause48,conjecture,~ ssSkC0 | in(skc18,skc22,skc25) ).
