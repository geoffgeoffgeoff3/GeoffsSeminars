...
fof(problem_9_142,conjecture,topological_space(cx,ct) ).
fof(problem_9_143,conjecture,subset_sets(a,cx) ).
fof(problem_9_144,conjecture,open(a,cx,ct) | equal_sets(a,interior(a,cx,ct)) | closed(a,cx,ct) | equal_sets(a,closure(a,cx,ct)) ).
