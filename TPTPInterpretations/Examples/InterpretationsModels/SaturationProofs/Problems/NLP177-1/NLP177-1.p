...
fof(clause79,conjecture,old(skc8,skc17) ).
fof(clause80,conjecture,dirty(skc8,skc17) ).
fof(clause81,conjecture,white(skc8,skc17) ).
fof(clause82,conjecture,chevy(skc8,skc17) ).
fof(clause83,conjecture,frontseat(skc8,skc17) ).
...
fof(clause91,conjecture,of(skc8,skc16,skc15) ).
fof(clause92,conjecture,in(skc8,skc14,skc15) ).
fof(clause93,conjecture,down(skc8,skc14,skc15) ).
fof(clause94,conjecture,agent(skc8,skc14,skc17) ).
...
fof(clause101,conjecture,! [U] : ! [V] : ( ~ member(skc8,U,skc13) | in(skc8,skf7(V),skc17) ) ).
