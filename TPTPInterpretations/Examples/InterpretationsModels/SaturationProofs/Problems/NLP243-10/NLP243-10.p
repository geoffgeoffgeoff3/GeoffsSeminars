...
fof(clause76,conjecture,event(skc15,skc24) = true ).
fof(clause77,conjecture,jules_forename(skc14,skc23) = true ).
fof(clause78,conjecture,forename(skc14,skc23) = true ).
fof(clause79,conjecture,present(skc15,skc24) = true ).
fof(clause80,conjecture,smoke(skc15,skc24) = true ).
fof(clause81,conjecture,man(skc14,skc22) = true ).
fof(clause82,conjecture,vincent_forename(skc14,skc21) = true ).
fof(clause83,conjecture,forename(skc14,skc21) = true ).
fof(clause84,conjecture,think_believe_consider(skc14,skc20) = true ).
...
fof(clause94,conjecture,accessible_world(skc14,skc19) = true ).
fof(clause95,conjecture,accessible_world(skc14,skc15) = true ).
fof(clause96,conjecture,proposition(skc14,skc15) = true ).
...
fof(clause101,conjecture,agent(skc14,skc20,skc22) = true ).
fof(clause102,conjecture,of(skc14,skc21,skc22) = true ).
fof(clause103,conjecture,theme(skc14,skc20,skc19) = true ).
...
fof(clause108,conjecture,! [U] : ! [V] : ifeq2(man(skc19,U),true,smoke(skc19,skf1(V)),true) = true ).
fof(clause109,conjecture,! [U] : ! [V] : ifeq2(man(skc19,U),true,present(skc19,skf1(V)),true) = true ).
fof(clause110,conjecture,! [U] : ! [V] : ifeq2(man(skc19,U),true,event(skc19,skf1(V)),true) = true ).
