...
fof(clause79,conjecture,frontseat(skc12,skc23) ).
fof(clause80,conjecture,group(skc12,skc22) ).
fof(clause81,conjecture,two(skc12,skc22) ).
fof(clause82,conjecture,hollywood_placename(skc12,skc19) ).
fof(clause83,conjecture,placename(skc12,skc19) ).
fof(clause84,conjecture,lonely(skc12,skc18) ).
fof(clause85,conjecture,street(skc12,skc18) ).
fof(clause86,conjecture,city(skc12,skc18) ).
fof(clause87,conjecture,wheel(skc12,skc18) ).
fof(clause88,conjecture,man(skc12,skc16) ).
fof(clause89,conjecture,state(skc12,skc14) ).
fof(clause90,conjecture,forename(skc12,skc15) ).
fof(clause91,conjecture,jules_forename(skc12,skc15) ).
fof(clause92,conjecture,old(skc12,skc20) ).
fof(clause93,conjecture,dirty(skc12,skc20) ).
fof(clause94,conjecture,white(skc12,skc20) ).
fof(clause95,conjecture,chevy(skc12,skc20) ).
fof(clause96,conjecture,event(skc12,skc17) ).
fof(clause97,conjecture,present(skc12,skc17) ).
fof(clause98,conjecture,barrel(skc12,skc17) ).
fof(clause99,conjecture,group(skc12,skc21) ).
fof(clause100,conjecture,agent(skc12,skc17,skc20) ).
fof(clause101,conjecture,of(skc12,skc19,skc18) ).
fof(clause102,conjecture,behind(skc12,skc13,skc18) ).
fof(clause103,conjecture,in(skc12,skc17,skc18) ).
fof(clause104,conjecture,down(skc12,skc17,skc18) ).
fof(clause105,conjecture,of(skc12,skc15,skc16) ).
fof(clause106,conjecture,be(skc12,skc14,skc16,skc13) ).
fof(clause107,conjecture,! [U] : ( ~ member(skc12,U,skc22) | young(skc12,U) ) ).
fof(clause108,conjecture,! [U] : ( ~ member(skc12,U,skc22) | fellow(skc12,U) ) ).
fof(clause109,conjecture,! [U] : ( ~ member(skc12,U,skc21) | cheap(skc12,U) ) ).
fof(clause110,conjecture,! [U] : ( ~ member(skc12,U,skc21) | black(skc12,U) ) ).
fof(clause111,conjecture,! [U] : ( ~ member(skc12,U,skc21) | coat(skc12,U) ) ).
fof(clause112,conjecture,! [U] : ! [V] : ( ~ member(skc12,U,skc22) | state(skc12,skf7(V)) ) ).
fof(clause113,conjecture,! [U] : ! [V] : ( ~ member(skc12,U,skc22) | in(skc12,skf6(V),skc23) ) ).
fof(clause114,conjecture,! [U] : ( ~ member(skc12,U,skc22) | be(skc12,skf7(U),U,skf6(U)) ) ).
fof(clause115,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc12,U,skc22) | ~ member(skc12,V,skc21) | event(skc12,skf8(W,X)) ) ).
fof(clause116,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc12,U,skc22) | ~ member(skc12,V,skc21) | present(skc12,skf8(W,X)) ) ).
fof(clause117,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc12,U,skc22) | ~ member(skc12,V,skc21) | nonreflexive(skc12,skf8(W,X)) ) ).
fof(clause118,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc12,U,skc22) | ~ member(skc12,V,skc21) | wear(skc12,skf8(W,X)) ) ).
fof(clause119,conjecture,! [U] : ! [V] : ! [W] : ( ~ member(skc12,U,skc22) | ~ member(skc12,V,skc21) | agent(skc12,skf8(U,W),U) ) ).
fof(clause120,conjecture,! [U] : ! [V] : ( ~ member(skc12,U,skc22) | ~ member(skc12,V,skc21) | patient(skc12,skf8(U,V),V) ) ).
