...
fof(clause74,conjecture,forename(skc8,skc14) = true ).
...
fof(clause93,conjecture,! [U] : ifeq2(man(skc12,U),true,agent(skc12,skf1(U),U),true) = true ).
