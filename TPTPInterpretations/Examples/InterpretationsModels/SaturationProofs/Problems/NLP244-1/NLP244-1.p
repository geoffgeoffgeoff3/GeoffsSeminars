...
fof(clause79,conjecture,event(skc15,skc23) ).
fof(clause80,conjecture,man(skc14,skc22) ).
fof(clause81,conjecture,present(skc15,skc23) ).
fof(clause82,conjecture,smoke(skc15,skc23) ).
fof(clause83,conjecture,forename(skc14,skc19) ).
fof(clause84,conjecture,jules_forename(skc14,skc19) ).
fof(clause85,conjecture,man(skc14,skc18) ).
fof(clause86,conjecture,vincent_forename(skc14,skc20) ).
fof(clause87,conjecture,forename(skc14,skc20) ).
fof(clause88,conjecture,state(skc14,skc17) ).
fof(clause89,conjecture,event(skc14,skc16) ).
fof(clause90,conjecture,present(skc14,skc16) ).
fof(clause91,conjecture,think_believe_consider(skc14,skc16) ).
fof(clause92,conjecture,accessible_world(skc14,skc15) ).
fof(clause93,conjecture,proposition(skc14,skc15) ).
fof(clause94,conjecture,forename(skc14,skc21) ).
fof(clause95,conjecture,jules_forename(skc14,skc21) ).
...
fof(clause101,conjecture,of(skc14,skc21,skc22) ).
fof(clause102,conjecture,agent(skc15,skc23,skc22) ).
fof(clause103,conjecture,of(skc14,skc20,skc18) ).
fof(clause104,conjecture,of(skc14,skc19,skc18) ).
fof(clause105,conjecture,agent(skc14,skc16,skc18) ).
fof(clause106,conjecture,theme(skc14,skc16,skc15) ).
fof(clause107,conjecture,be(skc14,skc17,skc18,skc18) ).
