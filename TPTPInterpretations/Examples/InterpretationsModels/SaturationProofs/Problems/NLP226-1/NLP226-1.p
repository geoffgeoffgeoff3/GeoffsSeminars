...
fof(clause90,conjecture,! [U] : ! [V] : ( ~ man(skc12,U) | smoke(skc12,skf1(V)) ) ).
fof(clause91,conjecture,! [U] : ! [V] : ( ~ man(skc12,U) | present(skc12,skf1(V)) ) ).
fof(clause92,conjecture,! [U] : ! [V] : ( ~ man(skc12,U) | event(skc12,skf1(V)) ) ).
fof(clause93,conjecture,! [U] : ( ~ man(skc12,U) | agent(skc12,skf1(U),U) ) ).
