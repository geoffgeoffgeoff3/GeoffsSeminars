...
fof(clause56,conjecture,! [U] : ! [V] : ( ~ member(skc2,U,skc3) | three(skc2,skf9(V)) ) ).
fof(clause57,conjecture,! [U] : ! [V] : ( ~ member(skc2,U,skc3) | group(skc2,skf9(V)) ) ).
fof(clause58,conjecture,! [U] : ! [V] : ( ~ member(skc2,U,skc3) | table(skc2,skf11(V)) ) ).
fof(clause59,conjecture,! [U] : ! [V] : ! [W] : ( ~ member(skc2,U,skf9(V)) | ~ member(skc2,W,skc3) | guy(skc2,U) ) ).
fof(clause60,conjecture,! [U] : ! [V] : ! [W] : ( ~ member(skc2,U,skf9(V)) | ~ member(skc2,W,skc3) | young(skc2,U) ) ).
...
fof(clause64,conjecture,! [U] : ! [V] : ! [W] : ( ~ member(skc2,U,skf9(V)) | ~ member(skc2,V,skc3) | agent(skc2,skf12(U,W),U) ) ).
fof(clause65,conjecture,! [U] : ! [V] : ( ~ member(skc2,U,skf9(V)) | ~ member(skc2,V,skc3) | with(skc2,skf12(U,V),V) ) ).
