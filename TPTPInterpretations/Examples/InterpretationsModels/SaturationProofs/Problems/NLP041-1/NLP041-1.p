...
fof(clause59,conjecture,! [U] : ! [V] : ! [W] : ( ~ member(skc2,U,skf9(V)) | ~ member(skc2,W,skc3) | hamburger(skc2,U) ) ).
...
fof(clause64,conjecture,! [U] : ! [V] : ! [W] : ( ~ member(skc2,U,skf9(V)) | ~ member(skc2,V,skc3) | with(skc2,skf10(U,W),U) ) ).
fof(clause65,conjecture,! [U] : ! [V] : ( ~ member(skc2,U,skf9(V)) | ~ member(skc2,V,skc3) | agent(skc2,skf10(U,V),V) ) ).
