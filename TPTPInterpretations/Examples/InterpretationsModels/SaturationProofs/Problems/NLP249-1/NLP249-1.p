...
fof(clause73,conjecture,jules_forename(skc13,skc26) ).
fof(clause74,conjecture,forename(skc13,skc26) ).
fof(clause75,conjecture,man(skc13,skc25) ).
fof(clause76,conjecture,event(skc14,skc21) ).
fof(clause77,conjecture,forename(skc13,skc20) ).
fof(clause78,conjecture,vincent_forename(skc13,skc20) ).
fof(clause79,conjecture,man(skc13,skc19) ).
fof(clause80,conjecture,present(skc14,skc21) ).
fof(clause81,conjecture,smoke(skc14,skc21) ).
fof(clause82,conjecture,jules_forename(skc13,skc22) ).
fof(clause83,conjecture,forename(skc13,skc22) ).
...
fof(clause96,conjecture,state(skc13,skc24) ).
fof(clause97,conjecture,of(skc13,skc26,skc25) ).
fof(clause98,conjecture,of(skc13,skc22,skc19) ).
fof(clause99,conjecture,of(skc13,skc20,skc19) ).
fof(clause100,conjecture,of(skc13,skc18,skc19) ).
fof(clause101,conjecture,agent(skc13,skc17,skc19) ).
fof(clause102,conjecture,agent(skc13,skc15,skc19) ).
fof(clause103,conjecture,agent(skc14,skc21,skc19) ).
fof(clause104,conjecture,theme(skc13,skc17,skc16) ).
fof(clause105,conjecture,theme(skc13,skc15,skc14) ).
fof(clause106,conjecture,be(skc13,skc24,skc25,skc25) ).
