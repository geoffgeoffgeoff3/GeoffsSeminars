...
fof(clause76,conjecture,frontseat(skc6,skc9) ).
fof(clause77,conjecture,street(skc6,skc9) ).
fof(clause78,conjecture,lonely(skc6,skc9) ).
fof(clause79,conjecture,barrel(skc6,skc8) ).
fof(clause80,conjecture,present(skc6,skc8) ).
fof(clause81,conjecture,event(skc6,skc8) ).
fof(clause82,conjecture,old(skc6,skc10) ).
fof(clause83,conjecture,dirty(skc6,skc10) ).
fof(clause84,conjecture,white(skc6,skc10) ).
fof(clause85,conjecture,chevy(skc6,skc10) ).
fof(clause86,conjecture,city(skc6,skc10) ).
...
fof(clause92,conjecture,ssSkP1(skc9,skc7,skc6) ).
...
fof(clause107,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ( ~ two(U,V) | ~ group(U,V) | ~ ssSkP0(V,U) | ~ in(U,W,X) | ~ agent(U,W,X) | ~ old(U,X) | ~ dirty(U,X) | ~ white(U,X) | ~ chevy(U,X) | ~ city(U,X) | ~ of(U,Y,X) | ~ hollywood_placename(U,Y) | ~ placename(U,Y) | ~ barrel(U,W) | ~ present(U,W) | ~ event(U,W) | ~ frontseat(U,Z) | ~ street(U,Z) | ~ lonely(U,Z) | ~ down(U,W,Z) | ~ ssSkP1(Z,V,U) | ~ ssSkP2(X1,X2,U) | ~ group(U,X1) | ~ group(U,X2) | ~ actual_world(U) | member(U,skf10(U,X2),X2) ) ).
fof(clause108,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ! [X3] : ( ~ two(U,V) | ~ group(U,V) | ~ ssSkP0(V,U) | ~ in(U,W,X) | ~ agent(U,W,X) | ~ old(U,X) | ~ dirty(U,X) | ~ white(U,X) | ~ chevy(U,X) | ~ city(U,X) | ~ of(U,Y,X) | ~ hollywood_placename(U,Y) | ~ placename(U,Y) | ~ barrel(U,W) | ~ present(U,W) | ~ event(U,W) | ~ frontseat(U,Z) | ~ street(U,Z) | ~ lonely(U,Z) | ~ down(U,W,Z) | ~ ssSkP1(Z,V,U) | ~ ssSkP2(X1,X2,U) | ~ group(U,X1) | ~ cheap(U,skf10(U,X3)) | ~ black(U,skf10(U,X3)) | ~ coat(U,skf10(U,X3)) | ~ group(U,X2) | ~ actual_world(U) ) ).
