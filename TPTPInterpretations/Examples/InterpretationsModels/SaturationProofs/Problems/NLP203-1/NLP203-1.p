...
fof(clause79,conjecture,hollywood_placename(skc12,skc26) ).
fof(clause80,conjecture,placename(skc12,skc26) ).
fof(clause81,conjecture,lonely(skc12,skc25) ).
fof(clause82,conjecture,street(skc12,skc25) ).
fof(clause83,conjecture,city(skc12,skc25) ).
fof(clause84,conjecture,wheel(skc12,skc19) ).
fof(clause85,conjecture,frontseat(skc12,skc19) ).
fof(clause86,conjecture,group(skc12,skc18) ).
fof(clause87,conjecture,two(skc12,skc18) ).
...
fof(clause92,conjecture,group(skc12,skc17) ).
fof(clause93,conjecture,old(skc12,skc27) ).
fof(clause94,conjecture,dirty(skc12,skc27) ).
fof(clause95,conjecture,white(skc12,skc27) ).
fof(clause96,conjecture,chevy(skc12,skc27) ).
fof(clause97,conjecture,event(skc12,skc24) ).
fof(clause98,conjecture,present(skc12,skc24) ).
fof(clause99,conjecture,barrel(skc12,skc24) ).
fof(clause100,conjecture,agent(skc12,skc24,skc27) ).
fof(clause101,conjecture,of(skc12,skc26,skc25) ).
fof(clause102,conjecture,in(skc12,skc24,skc25) ).
fof(clause103,conjecture,down(skc12,skc24,skc25) ).
fof(clause104,conjecture,behind(skc12,skc13,skc19) ).
fof(clause105,conjecture,of(skc12,skc15,skc16) ).
fof(clause106,conjecture,be(skc12,skc14,skc16,skc13) ).
fof(clause107,conjecture,! [U] : ( ~ member(skc12,U,skc18) | young(skc12,U) ) ).
fof(clause108,conjecture,! [U] : ( ~ member(skc12,U,skc18) | fellow(skc12,U) ) ).
fof(clause109,conjecture,! [U] : ( ~ member(skc12,U,skc17) | cheap(skc12,U) ) ).
fof(clause110,conjecture,! [U] : ( ~ member(skc12,U,skc17) | black(skc12,U) ) ).
fof(clause111,conjecture,! [U] : ( ~ member(skc12,U,skc17) | coat(skc12,U) ) ).
fof(clause112,conjecture,! [U] : ! [V] : ( ~ member(skc12,U,skc18) | state(skc12,skf7(V)) ) ).
fof(clause113,conjecture,! [U] : ! [V] : ( ~ member(skc12,U,skc18) | in(skc12,skf6(V),skc19) ) ).
fof(clause114,conjecture,! [U] : ( ~ member(skc12,U,skc18) | be(skc12,skf7(U),U,skf6(U)) ) ).
fof(clause115,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc12,U,skc18) | ~ member(skc12,V,skc17) | event(skc12,skf8(W,X)) ) ).
fof(clause116,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc12,U,skc18) | ~ member(skc12,V,skc17) | present(skc12,skf8(W,X)) ) ).
fof(clause117,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc12,U,skc18) | ~ member(skc12,V,skc17) | nonreflexive(skc12,skf8(W,X)) ) ).
fof(clause118,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc12,U,skc18) | ~ member(skc12,V,skc17) | wear(skc12,skf8(W,X)) ) ).
fof(clause119,conjecture,! [U] : ! [V] : ! [W] : ( ~ member(skc12,U,skc18) | ~ member(skc12,V,skc17) | agent(skc12,skf8(U,W),U) ) ).
fof(clause120,conjecture,! [U] : ! [V] : ( ~ member(skc12,U,skc18) | ~ member(skc12,V,skc17) | patient(skc12,skf8(U,V),V) ) ).
