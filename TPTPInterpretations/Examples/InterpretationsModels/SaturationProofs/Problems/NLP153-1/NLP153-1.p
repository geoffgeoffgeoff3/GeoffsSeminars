...
fof(clause71,conjecture,street(skc5,skc7) ).
fof(clause72,conjecture,lonely(skc5,skc7) ).
fof(clause73,conjecture,barrel(skc5,skc6) ).
fof(clause74,conjecture,present(skc5,skc6) ).
fof(clause75,conjecture,event(skc5,skc6) ).
fof(clause76,conjecture,old(skc5,skc8) ).
fof(clause77,conjecture,dirty(skc5,skc8) ).
fof(clause78,conjecture,white(skc5,skc8) ).
fof(clause79,conjecture,chevy(skc5,skc8) ).
...
fof(clause84,conjecture,agent(skc5,skc6,skc8) ).
...
fof(clause87,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ( ~ city(U,V) | ~ chevy(U,V) | ~ white(U,V) | ~ dirty(U,V) | ~ old(U,V) | ~ agent(U,W,V) | ~ in(U,W,V) | ~ placename(U,X) | ~ hollywood_placename(U,X) | ~ of(U,X,V) | ~ event(U,W) | ~ present(U,W) | ~ barrel(U,W) | ~ down(U,W,Y) | ~ lonely(U,Y) | ~ street(U,Y) | ~ group(U,Z) | ~ two(U,Z) | ~ ssSkP0(Z,U) | ~ actual_world(U) | member(U,skf5(U,Z),Z) ) ).
fof(clause88,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ( ~ city(U,V) | ~ chevy(U,V) | ~ white(U,V) | ~ dirty(U,V) | ~ old(U,V) | ~ agent(U,W,V) | ~ in(U,W,V) | ~ placename(U,X) | ~ hollywood_placename(U,X) | ~ of(U,X,V) | ~ event(U,W) | ~ present(U,W) | ~ barrel(U,W) | ~ down(U,W,Y) | ~ lonely(U,Y) | ~ street(U,Y) | ~ young(U,skf5(U,Z)) | ~ fellow(U,skf5(U,Z)) | ~ group(U,X1) | ~ two(U,X1) | ~ ssSkP0(X1,U) | ~ actual_world(U) ) ).
