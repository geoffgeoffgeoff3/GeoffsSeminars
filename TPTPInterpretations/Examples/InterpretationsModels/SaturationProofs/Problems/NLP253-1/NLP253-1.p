...
fof(clause72,conjecture,actual_world(skc8) ).
fof(clause73,conjecture,man(skc8,skc15) ).
fof(clause74,conjecture,forename(skc8,skc14) ).
fof(clause75,conjecture,vincent_forename(skc8,skc14) ).
fof(clause76,conjecture,event(skc8,skc13) ).
fof(clause77,conjecture,present(skc8,skc13) ).
fof(clause78,conjecture,think_believe_consider(skc8,skc13) ).
fof(clause79,conjecture,jules_forename(skc8,skc11) ).
fof(clause80,conjecture,forename(skc8,skc11) ).
fof(clause81,conjecture,man(skc8,skc10) ).
fof(clause82,conjecture,state(skc8,skc9) ).
fof(clause83,conjecture,accessible_world(skc8,skc12) ).
fof(clause84,conjecture,proposition(skc8,skc12) ).
fof(clause85,conjecture,of(skc8,skc14,skc15) ).
fof(clause86,conjecture,agent(skc8,skc13,skc15) ).
fof(clause87,conjecture,theme(skc8,skc13,skc12) ).
fof(clause88,conjecture,of(skc8,skc11,skc10) ).
fof(clause89,conjecture,be(skc8,skc9,skc10,skc10) ).
fof(clause90,conjecture,! [U] : ! [V] : ( ~ man(skc12,U) | smoke(skc12,skf2(V)) ) ).
fof(clause91,conjecture,! [U] : ! [V] : ( ~ man(skc12,U) | present(skc12,skf2(V)) ) ).
fof(clause92,conjecture,! [U] : ! [V] : ( ~ man(skc12,U) | event(skc12,skf2(V)) ) ).
fof(clause93,conjecture,! [U] : ( ~ man(skc12,U) | agent(skc12,skf2(U),U) ) ).
...
fof(clause95,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ! [X3] : ! [X4] : ! [X5] : ! [X6] : ! [X7] : ! [X8] : ! [X9] : ( ~ state(U,V) | ~ be(U,V,W,W) | ~ man(U,W) | ~ of(U,X,W) | ~ jules_forename(U,X) | ~ forename(U,X) | ~ proposition(U,Y) | ~ accessible_world(U,Y) | ~ smoke(Z,X1) | ~ present(Z,X1) | ~ agent(Z,X1,skf4(Z)) | ~ event(Z,X1) | ~ accessible_world(U,Z) | ~ proposition(U,Z) | ~ theme(U,X2,Z) | ~ event(U,X2) | ~ present(U,X2) | ~ think_believe_consider(U,X2) | ~ forename(U,X3) | ~ vincent_forename(U,X3) | ~ of(U,X3,X4) | ~ man(U,X4) | ~ agent(U,X2,X4) | ~ smoke(Y,X5) | ~ present(Y,X5) | ~ agent(Y,X5,X4) | ~ event(Y,X5) | ~ forename(U,X6) | ~ jules_forename(U,X6) | ~ of(U,X6,X4) | ~ think_believe_consider(U,X7) | ~ present(U,X7) | ~ event(U,X7) | ~ theme(U,X7,Y) | ~ vincent_forename(U,X8) | ~ forename(U,X8) | ~ agent(U,X7,X9) | ~ man(U,X9) | ~ of(U,X8,X9) | ~ actual_world(U) ) ).
