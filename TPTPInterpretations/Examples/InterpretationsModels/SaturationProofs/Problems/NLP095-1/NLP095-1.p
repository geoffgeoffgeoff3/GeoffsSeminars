...
fof(clause23,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc3,U) | ~ in(skc3,V,U) | ~ customer(skc3,V) | ~ ssSkC0 | coffee(skc3,skf13(W)) ) ).
...
fof(clause28,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc3,U) | ~ in(skc3,V,U) | ~ customer(skc3,V) | ~ ssSkC0 | human_person(skc3,skf14(W)) ) ).
...
fof(clause34,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc3,U) | ~ in(skc3,V,U) | ~ customer(skc3,V) | ~ ssSkC0 | patient(skc3,skf12(W),skf13(W)) ) ).
fof(clause35,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc3,U) | ~ in(skc3,V,U) | ~ customer(skc3,V) | ~ ssSkC0 | agent(skc3,skf12(W),skf14(W)) ) ).
fof(clause36,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc3,U) | ~ in(skc3,V,U) | ~ customer(skc3,V) | ~ ssSkC0 | patient(skc3,skf11(W),skf14(W)) ) ).
fof(clause37,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ( ~ event(U,V) | ~ agent(U,V,skf37(U)) | ~ past(U,V) | ~ nonreflexive(U,V) | ~ see(U,V) | ~ patient(U,W,X) | ~ coffee(U,X) | ~ drink(U,W) | ~ nonreflexive(U,W) | ~ past(U,W) | ~ event(U,W) | ~ human_person(U,Y) | ~ agent(U,W,Y) | ~ patient(U,V,Y) | ~ actual_world(U) | ssSkC0 ) ).
