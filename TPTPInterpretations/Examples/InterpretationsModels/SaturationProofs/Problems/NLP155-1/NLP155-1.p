...
fof(clause65,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ( skf13(U,V,W,X) != U | ~ member(Y,U,Z) | ~ member(Y,X1,Z) | two(Y,Z) | U = X1 ) ).
...
fof(clause69,conjecture,chevy(skc6,skc11) ).
fof(clause70,conjecture,city(skc6,skc10) ).
fof(clause71,conjecture,lonely(skc6,skc8) ).
fof(clause72,conjecture,street(skc6,skc8) ).
fof(clause73,conjecture,placename(skc6,skc9) ).
fof(clause74,conjecture,hollywood_placename(skc6,skc9) ).
fof(clause75,conjecture,event(skc6,skc7) ).
fof(clause76,conjecture,present(skc6,skc7) ).
fof(clause77,conjecture,barrel(skc6,skc7) ).
fof(clause78,conjecture,white(skc6,skc11) ).
fof(clause79,conjecture,dirty(skc6,skc11) ).
fof(clause80,conjecture,old(skc6,skc11) ).
fof(clause81,conjecture,of(skc6,skc9,skc10) ).
fof(clause82,conjecture,in(skc6,skc7,skc10) ).
fof(clause83,conjecture,down(skc6,skc7,skc8) ).
fof(clause84,conjecture,agent(skc6,skc7,skc11) ).
fof(clause85,conjecture,! [U] : ! [V] : ( ssSkP0(U,V) | member(V,skf8(V,U),U) ) ).
fof(clause86,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ( ~ frontseat(U,V) | ~ in(U,V,V) | ~ be(U,W,skf8(U,X),V) | ~ state(U,W) | ssSkP0(Y,U) ) ).
fof(clause87,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ( ~ agent(U,V,W) | ~ old(U,W) | ~ dirty(U,W) | ~ white(U,W) | ~ chevy(U,W) | ~ barrel(U,V) | ~ present(U,V) | ~ event(U,V) | ~ hollywood_placename(U,X) | ~ placename(U,X) | ~ in(U,V,Y) | ~ city(U,Y) | ~ of(U,X,Y) | ~ street(U,Z) | ~ lonely(U,Z) | ~ down(U,V,Z) | ~ ssSkP0(X1,U) | ~ two(U,X1) | ~ group(U,X1) | ~ actual_world(U) | member(U,skf5(U,X1),X1) ) ).
fof(clause88,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ( ~ agent(U,V,W) | ~ old(U,W) | ~ dirty(U,W) | ~ white(U,W) | ~ chevy(U,W) | ~ barrel(U,V) | ~ present(U,V) | ~ event(U,V) | ~ hollywood_placename(U,X) | ~ placename(U,X) | ~ in(U,V,Y) | ~ city(U,Y) | ~ of(U,X,Y) | ~ street(U,Z) | ~ lonely(U,Z) | ~ down(U,V,Z) | ~ ssSkP0(X1,U) | ~ two(U,X1) | ~ group(U,X1) | ~ young(U,skf5(U,X2)) | ~ fellow(U,skf5(U,X2)) | ~ actual_world(U) ) ).
