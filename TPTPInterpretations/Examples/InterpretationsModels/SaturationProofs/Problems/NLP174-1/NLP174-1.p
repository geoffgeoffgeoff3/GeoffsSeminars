...
fof(clause74,conjecture,placename(skc8,skc17) ).
fof(clause75,conjecture,hollywood_placename(skc8,skc17) ).
fof(clause76,conjecture,lonely(skc8,skc15) ).
fof(clause77,conjecture,street(skc8,skc15) ).
fof(clause78,conjecture,event(skc8,skc14) ).
fof(clause79,conjecture,present(skc8,skc14) ).
fof(clause80,conjecture,barrel(skc8,skc14) ).
fof(clause81,conjecture,frontseat(skc8,skc16) ).
fof(clause82,conjecture,city(skc8,skc16) ).
fof(clause83,conjecture,chevy(skc8,skc16) ).
fof(clause84,conjecture,white(skc8,skc16) ).
fof(clause85,conjecture,dirty(skc8,skc16) ).
fof(clause86,conjecture,old(skc8,skc16) ).
...
fof(clause91,conjecture,of(skc8,skc17,skc16) ).
fof(clause92,conjecture,down(skc8,skc14,skc15) ).
fof(clause93,conjecture,agent(skc8,skc14,skc16) ).
fof(clause94,conjecture,in(skc8,skc14,skc16) ).
...
fof(clause101,conjecture,! [U] : ! [V] : ( ~ member(skc8,U,skc13) | in(skc8,skf7(V),skc16) ) ).
