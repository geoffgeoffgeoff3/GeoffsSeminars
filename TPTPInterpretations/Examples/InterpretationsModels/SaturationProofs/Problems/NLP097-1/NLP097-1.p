...
fof(clause26,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc4,U) | ~ in(skc4,V,U) | ~ customer(skc4,V) | ~ ssSkC0 | coffee(skc4,skf12(W)) ) ).
...
fof(clause31,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc4,U) | ~ in(skc4,V,U) | ~ customer(skc4,V) | ~ ssSkC0 | human_person(skc4,skf13(W)) ) ).
...
fof(clause34,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc4,U) | ~ in(skc4,V,U) | ~ customer(skc4,V) | ~ ssSkC0 | patient(skc4,skf10(W),skf13(W)) ) ).
fof(clause35,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc4,U) | ~ in(skc4,V,U) | ~ customer(skc4,V) | ~ ssSkC0 | patient(skc4,skf11(W),skf12(W)) ) ).
fof(clause36,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc4,U) | ~ in(skc4,V,U) | ~ customer(skc4,V) | ~ ssSkC0 | agent(skc4,skf11(W),skf13(W)) ) ).
fof(clause37,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ( ~ event(U,V) | ~ agent(U,V,skf32(U)) | ~ past(U,V) | ~ nonreflexive(U,V) | ~ see(U,V) | ~ patient(U,W,X) | ~ coffee(U,X) | ~ drink(U,W) | ~ nonreflexive(U,W) | ~ past(U,W) | ~ event(U,W) | ~ human_person(U,Y) | ~ agent(U,W,Y) | ~ patient(U,V,Y) | ~ actual_world(U) | ssSkC0 ) ).
