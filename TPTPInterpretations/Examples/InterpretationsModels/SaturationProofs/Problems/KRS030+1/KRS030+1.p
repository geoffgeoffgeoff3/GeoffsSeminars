...
fof(axiom_4,conjecture,! [X] : ! [Y] : ! [Z] : ( ( rf1(X,Y) & rf1(X,Z) ) => Y = Z ) ).
fof(axiom_5,conjecture,! [X] : ! [Y] : ( rinvF(X,Y) <=> rf(Y,X) ) ).
fof(axiom_6,conjecture,! [X] : ! [Y] : ( rinvF1(X,Y) <=> rf1(Y,X) ) ).
fof(axiom_7,conjecture,! [X] : ! [Y] : ( rinvS(X,Y) <=> rs(Y,X) ) ).
fof(axiom_8,conjecture,! [X] : ! [Y] : ! [Z] : ( ( rs(X,Y) & rs(X,Z) ) => Y = Z ) ).
fof(axiom_9,conjecture,cSatisfiable(i2003_11_14_17_15_26245) ).
fof(axiom_10,conjecture,! [X] : ! [Y] : ( rs(X,Y) => rf(X,Y) ) ).
fof(axiom_11,conjecture,! [X] : ! [Y] : ( rs(X,Y) => rf1(X,Y) ) ).
