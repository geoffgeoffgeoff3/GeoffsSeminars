...
fof(clause73,conjecture,man(skc13,skc25) = true ).
fof(clause74,conjecture,forename(skc13,skc24) = true ).
fof(clause75,conjecture,vincent_forename(skc13,skc24) = true ).
fof(clause76,conjecture,event(skc13,skc23) = true ).
...
fof(clause80,conjecture,event(skc14,skc20) = true ).
fof(clause81,conjecture,jules_forename(skc13,skc18) = true ).
fof(clause82,conjecture,forename(skc13,skc18) = true ).
fof(clause83,conjecture,jules_forename(skc13,skc19) = true ).
fof(clause84,conjecture,forename(skc13,skc19) = true ).
fof(clause85,conjecture,present(skc14,skc20) = true ).
fof(clause86,conjecture,smoke(skc14,skc20) = true ).
...
fof(clause92,conjecture,event(skc13,skc15) = true ).
fof(clause93,conjecture,proposition(skc13,skc14) = true ).
fof(clause94,conjecture,accessible_world(skc13,skc14) = true ).
fof(clause95,conjecture,accessible_world(skc13,skc22) = true ).
fof(clause96,conjecture,proposition(skc13,skc22) = true ).
fof(clause97,conjecture,of(skc13,skc24,skc25) = true ).
fof(clause98,conjecture,agent(skc13,skc23,skc25) = true ).
...
fof(clause102,conjecture,agent(skc14,skc20,skc17) = true ).
fof(clause103,conjecture,agent(skc13,skc15,skc17) = true ).
fof(clause104,conjecture,of(skc13,skc21,skc17) = true ).
fof(clause105,conjecture,theme(skc13,skc15,skc14) = true ).
fof(clause106,conjecture,be(skc13,skc16,skc17,skc17) = true ).
fof(clause107,conjecture,! [U] : ! [V] : ifeq2(man(skc22,U),true,smoke(skc22,skf1(V)),true) = true ).
fof(clause108,conjecture,! [U] : ! [V] : ifeq2(man(skc22,U),true,present(skc22,skf1(V)),true) = true ).
fof(clause109,conjecture,! [U] : ! [V] : ifeq2(man(skc22,U),true,event(skc22,skf1(V)),true) = true ).
fof(clause110,conjecture,! [U] : ifeq2(man(skc22,U),true,agent(skc22,skf1(U),U),true) = true ).
