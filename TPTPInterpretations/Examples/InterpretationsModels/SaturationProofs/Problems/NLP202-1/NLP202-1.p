...
fof(clause87,conjecture,man(skc12,skc16) ).
fof(clause88,conjecture,state(skc12,skc14) ).
fof(clause89,conjecture,forename(skc12,skc15) ).
fof(clause90,conjecture,jules_forename(skc12,skc15) ).
fof(clause91,conjecture,old(skc12,skc20) ).
fof(clause92,conjecture,dirty(skc12,skc20) ).
fof(clause93,conjecture,white(skc12,skc20) ).
fof(clause94,conjecture,chevy(skc12,skc20) ).
fof(clause95,conjecture,wheel(skc12,skc20) ).
...
fof(clause100,conjecture,behind(skc12,skc13,skc20) ).
fof(clause101,conjecture,of(skc12,skc19,skc18) ).
fof(clause102,conjecture,in(skc12,skc17,skc18) ).
fof(clause103,conjecture,down(skc12,skc17,skc18) ).
fof(clause104,conjecture,of(skc12,skc15,skc16) ).
fof(clause105,conjecture,agent(skc12,skc17,skc20) ).
