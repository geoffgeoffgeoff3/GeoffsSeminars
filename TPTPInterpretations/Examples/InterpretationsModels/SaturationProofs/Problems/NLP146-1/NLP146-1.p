...
fof(clause69,conjecture,street(skc6,skc14) ).
...
fof(clause73,conjecture,chevy(skc6,skc12) ).
fof(clause74,conjecture,white(skc6,skc12) ).
fof(clause75,conjecture,dirty(skc6,skc12) ).
fof(clause76,conjecture,old(skc6,skc12) ).
fof(clause77,conjecture,two(skc6,skc7) ).
fof(clause78,conjecture,group(skc6,skc7) ).
fof(clause79,conjecture,lonely(skc6,skc14) ).
...
fof(clause86,conjecture,down(skc6,skc11,skc14) ).
