...
fof(some_source,conjecture,! [I] : ( time(I) => ( source(block_1,I) | source(block_2,I) | source(block_3,I) | source(table,I) ) ) ).
...
fof(some_object,conjecture,! [I] : ( time(I) => ( object(block_1,I) | object(block_2,I) | object(block_3,I) ) ) ).
...
fof(initial_3_on_table,conjecture,on(block_3,table,time_0) ).
fof(initial_clear_3,conjecture,clear(block_3,time_0) ).
fof(goal_time_3,conjecture,goal_time(s(s(s(time_0)))) ).
