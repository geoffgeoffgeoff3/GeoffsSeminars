...
fof(clause123,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ! [X3] : ! [X4] : ! [X5] : ( ~ group(U,V) | ~ ssSkP2(W,V,U) | ~ ssSkP0(W,U) | ~ group(U,W) | ~ two(U,W) | ~ event(U,X) | ~ present(U,X) | ~ barrel(U,X) | ~ agent(U,X,Y) | ~ old(U,Y) | ~ dirty(U,Y) | ~ white(U,Y) | ~ chevy(U,Y) | ~ ssSkP1(Z,W,U) | ~ in(U,X,Z) | ~ down(U,X,Z) | ~ lonely(U,Z) | ~ street(U,Z) | ~ city(U,Z) | ~ frontseat(U,Z) | ~ of(U,X1,Z) | ~ hollywood_placename(U,X1) | ~ placename(U,X1) | ~ wheel(U,X2) | ~ behind(U,X2,X2) | ~ state(U,X3) | ~ jules_forename(U,X4) | ~ forename(U,X4) | ~ be(U,X3,X5,X2) | ~ man(U,X5) | ~ of(U,X4,X5) | ~ actual_world(U) | member(U,skf11(U,V),V) ) ).
fof(clause124,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ! [X3] : ! [X4] : ! [X5] : ! [X6] : ( ~ group(U,V) | ~ cheap(U,skf11(U,W)) | ~ black(U,skf11(U,W)) | ~ coat(U,skf11(U,W)) | ~ ssSkP2(X,V,U) | ~ ssSkP0(X,U) | ~ group(U,X) | ~ two(U,X) | ~ event(U,Y) | ~ present(U,Y) | ~ barrel(U,Y) | ~ agent(U,Y,Z) | ~ old(U,Z) | ~ dirty(U,Z) | ~ white(U,Z) | ~ chevy(U,Z) | ~ ssSkP1(X1,X,U) | ~ in(U,Y,X1) | ~ down(U,Y,X1) | ~ lonely(U,X1) | ~ street(U,X1) | ~ city(U,X1) | ~ frontseat(U,X1) | ~ of(U,X2,X1) | ~ hollywood_placename(U,X2) | ~ placename(U,X2) | ~ wheel(U,X3) | ~ behind(U,X3,X3) | ~ state(U,X4) | ~ jules_forename(U,X5) | ~ forename(U,X5) | ~ be(U,X4,X6,X3) | ~ man(U,X6) | ~ of(U,X5,X6) | ~ actual_world(U) ) ).
