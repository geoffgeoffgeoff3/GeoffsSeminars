...
fof(axiom_2,conjecture,! [X] : ( cSatisfiable(X) <=> ( ? [Y] : ( rr(X,Y) & cp(Y) & cp3(Y) ) & ? [Y] : ( rr(X,Y) & cp1(Y) ) & ? [Y] : ( rr(X,Y) & cp5(Y) ) & ? [Y] : ( rr(X,Y) & cp(Y) & cp1(Y) ) & ? [Y] : ( rr(X,Y) & cp3(Y) ) & ? [Y] : ( rr(X,Y) & cp2(Y) ) & ? [Y] : ( rr(X,Y) & cp(Y) & cp2(Y) ) & ? [Y] : ( rr(X,Y) & cp(Y) & cp5(Y) ) & ! [Y0] : ! [Y1] : ! [Y2] : ! [Y3] : ! [Y4] : ! [Y5] : ( ( rr(X,Y0) & rr(X,Y1) & rr(X,Y2) & rr(X,Y3) & rr(X,Y4) & rr(X,Y5) ) => ( Y0 = Y1 | Y0 = Y2 | Y0 = Y3 | Y0 = Y4 | Y0 = Y5 | Y1 = Y2 | Y1 = Y3 | Y1 = Y4 | Y1 = Y5 | Y2 = Y3 | Y2 = Y4 | Y2 = Y5 | Y3 = Y4 | Y3 = Y5 | Y4 = Y5 ) ) & ? [Y] : ( rr(X,Y) & cp4(Y) ) & ? [Y] : ( rr(X,Y) & cp(Y) & cp4(Y) ) ) ) ).
fof(axiom_3,conjecture,! [X] : ( cp1(X) => ~ ( cp3(X) | cp5(X) | cp2(X) | cp4(X) ) ) ).
fof(axiom_4,conjecture,! [X] : ( cp2(X) => ~ ( cp3(X) | cp5(X) | cp4(X) ) ) ).
fof(axiom_5,conjecture,! [X] : ( cp3(X) => ~ ( cp5(X) | cp4(X) ) ) ).
fof(axiom_6,conjecture,! [X] : ( cp4(X) => ~ cp5(X) ) ).
fof(axiom_7,conjecture,cSatisfiable(i2003_11_14_17_15_408) ).
