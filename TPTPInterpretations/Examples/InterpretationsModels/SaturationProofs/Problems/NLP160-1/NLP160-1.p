...
fof(clause6,conjecture,ssSkC0 | frontseat(skc62,skc70) ).
fof(clause7,conjecture,ssSkC0 | chevy(skc62,skc70) ).
fof(clause8,conjecture,ssSkC0 | white(skc62,skc70) ).
fof(clause9,conjecture,ssSkC0 | dirty(skc62,skc70) ).
fof(clause10,conjecture,ssSkC0 | old(skc62,skc70) ).
fof(clause11,conjecture,ssSkC0 | event(skc62,skc66) ).
fof(clause12,conjecture,ssSkC0 | present(skc62,skc66) ).
fof(clause13,conjecture,ssSkC0 | barrel(skc62,skc66) ).
fof(clause14,conjecture,ssSkC0 | placename(skc62,skc68) ).
fof(clause15,conjecture,ssSkC0 | hollywood_placename(skc62,skc68) ).
fof(clause16,conjecture,ssSkC0 | city(skc62,skc69) ).
fof(clause17,conjecture,ssSkC0 | lonely(skc62,skc67) ).
fof(clause18,conjecture,ssSkC0 | street(skc62,skc67) ).
...
fof(clause40,conjecture,ssSkC0 | ssSkP1(skc70,skc65,skc62) ).
fof(clause41,conjecture,ssSkC0 | of(skc62,skc68,skc69) ).
fof(clause42,conjecture,ssSkC0 | in(skc62,skc66,skc69) ).
