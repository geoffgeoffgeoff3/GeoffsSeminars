...
fof(luka_op_or,conjecture,op_or ).
fof(luka_op_implies,conjecture,op_implies ).
fof(luka_op_equiv,conjecture,op_equiv ).
fof(luka_modus_ponens,conjecture,modus_ponens ).
fof(luka_cn1,conjecture,cn1 ).
fof(luka_cn2,conjecture,cn2 ).
fof(luka_cn3,conjecture,cn3 ).
