...
fof(clause74,conjecture,frontseat(skc6,skc11) ).
fof(clause75,conjecture,placename(skc6,skc10) ).
fof(clause76,conjecture,hollywood_placename(skc6,skc10) ).
fof(clause77,conjecture,city(skc6,skc9) ).
fof(clause78,conjecture,street(skc6,skc9) ).
fof(clause79,conjecture,lonely(skc6,skc9) ).
fof(clause80,conjecture,chevy(skc6,skc11) ).
fof(clause81,conjecture,white(skc6,skc11) ).
fof(clause82,conjecture,dirty(skc6,skc11) ).
fof(clause83,conjecture,old(skc6,skc11) ).
fof(clause84,conjecture,barrel(skc6,skc8) ).
fof(clause85,conjecture,present(skc6,skc8) ).
fof(clause86,conjecture,event(skc6,skc8) ).
fof(clause87,conjecture,two(skc6,skc7) ).
fof(clause88,conjecture,group(skc6,skc7) ).
fof(clause89,conjecture,ssSkP0(skc7,skc6) ).
fof(clause90,conjecture,of(skc6,skc10,skc9) ).
fof(clause91,conjecture,down(skc6,skc8,skc9) ).
fof(clause92,conjecture,in(skc6,skc8,skc9) ).
fof(clause93,conjecture,agent(skc6,skc8,skc11) ).
fof(clause94,conjecture,ssSkP1(skc11,skc7,skc6) ).
...
fof(clause107,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ( ~ two(U,V) | ~ group(U,V) | ~ ssSkP0(V,U) | ~ barrel(U,W) | ~ present(U,W) | ~ event(U,W) | ~ frontseat(U,X) | ~ chevy(U,X) | ~ white(U,X) | ~ dirty(U,X) | ~ old(U,X) | ~ agent(U,W,X) | ~ ssSkP1(X,V,U) | ~ city(U,Y) | ~ street(U,Y) | ~ lonely(U,Y) | ~ down(U,W,Y) | ~ in(U,W,Y) | ~ placename(U,Z) | ~ hollywood_placename(U,Z) | ~ of(U,Z,Y) | ~ ssSkP2(X1,X2,U) | ~ group(U,X1) | ~ group(U,X2) | ~ actual_world(U) | member(U,skf10(U,X2),X2) ) ).
fof(clause108,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ! [X3] : ( ~ two(U,V) | ~ group(U,V) | ~ ssSkP0(V,U) | ~ barrel(U,W) | ~ present(U,W) | ~ event(U,W) | ~ frontseat(U,X) | ~ chevy(U,X) | ~ white(U,X) | ~ dirty(U,X) | ~ old(U,X) | ~ agent(U,W,X) | ~ ssSkP1(X,V,U) | ~ city(U,Y) | ~ street(U,Y) | ~ lonely(U,Y) | ~ down(U,W,Y) | ~ in(U,W,Y) | ~ placename(U,Z) | ~ hollywood_placename(U,Z) | ~ of(U,Z,Y) | ~ ssSkP2(X1,X2,U) | ~ group(U,X1) | ~ cheap(U,skf10(U,X3)) | ~ black(U,skf10(U,X3)) | ~ coat(U,skf10(U,X3)) | ~ group(U,X2) | ~ actual_world(U) ) ).
