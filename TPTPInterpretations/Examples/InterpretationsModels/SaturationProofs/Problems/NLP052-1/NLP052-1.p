...
fof(clause79,conjecture,woman(skc6,skc11) ).
fof(clause80,conjecture,shake_beverage(skc6,skc9) ).
fof(clause81,conjecture,order(skc6,skc8) ).
fof(clause82,conjecture,nonreflexive(skc6,skc8) ).
fof(clause83,conjecture,past(skc6,skc8) ).
fof(clause84,conjecture,event(skc6,skc8) ).
fof(clause85,conjecture,forename(skc6,skc10) ).
fof(clause86,conjecture,mia_forename(skc6,skc10) ).
fof(clause87,conjecture,nonhuman(skc6,skc10) ).
fof(clause88,conjecture,five(skc6,skc7) ).
fof(clause89,conjecture,group(skc6,skc7) ).
fof(clause90,conjecture,of(skc6,skc10,skc11) ).
fof(clause91,conjecture,agent(skc6,skc8,skc11) ).
...
fof(clause99,conjecture,! [U] : ! [V] : ( ~ member(skc6,U,skc7) | agent(skc6,skf7(V),skc10) ) ).
