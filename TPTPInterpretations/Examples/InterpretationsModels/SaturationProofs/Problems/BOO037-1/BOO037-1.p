...
fof(multiplicative_identity1,conjecture,! [X] : product(multiplicative_identity,X,X) ).
fof(multiplicative_identity2,conjecture,! [X] : product(X,multiplicative_identity,X) ).
...
fof(distributivity7,conjecture,! [Y] : ! [X] : ! [V1] : ! [Z] : ! [V2] : ! [V3] : ! [V4] : ( ~ sum(Y,X,V1) | ~ sum(Z,X,V2) | ~ product(Y,Z,V3) | ~ sum(V3,X,V4) | product(V1,V2,V4) ) ).
