...
fof(clause74,conjecture,chevy(skc6,skc11) ).
fof(clause75,conjecture,placename(skc6,skc10) ).
fof(clause76,conjecture,hollywood_placename(skc6,skc10) ).
fof(clause77,conjecture,frontseat(skc6,skc9) ).
fof(clause78,conjecture,city(skc6,skc9) ).
fof(clause79,conjecture,street(skc6,skc9) ).
fof(clause80,conjecture,lonely(skc6,skc9) ).
...
fof(clause93,conjecture,ssSkP1(skc9,skc7,skc6) ).
fof(clause94,conjecture,agent(skc6,skc8,skc11) ).
...
fof(clause107,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ( ~ two(U,V) | ~ group(U,V) | ~ ssSkP0(V,U) | ~ barrel(U,W) | ~ present(U,W) | ~ event(U,W) | ~ chevy(U,X) | ~ white(U,X) | ~ dirty(U,X) | ~ old(U,X) | ~ agent(U,W,X) | ~ frontseat(U,Y) | ~ city(U,Y) | ~ street(U,Y) | ~ lonely(U,Y) | ~ down(U,W,Y) | ~ in(U,W,Y) | ~ ssSkP1(Y,V,U) | ~ placename(U,Z) | ~ hollywood_placename(U,Z) | ~ of(U,Z,Y) | ~ ssSkP2(X1,X2,U) | ~ group(U,X1) | ~ group(U,X2) | ~ actual_world(U) | member(U,skf10(U,X2),X2) ) ).
fof(clause108,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ! [X3] : ( ~ two(U,V) | ~ group(U,V) | ~ ssSkP0(V,U) | ~ barrel(U,W) | ~ present(U,W) | ~ event(U,W) | ~ chevy(U,X) | ~ white(U,X) | ~ dirty(U,X) | ~ old(U,X) | ~ agent(U,W,X) | ~ frontseat(U,Y) | ~ city(U,Y) | ~ street(U,Y) | ~ lonely(U,Y) | ~ down(U,W,Y) | ~ in(U,W,Y) | ~ ssSkP1(Y,V,U) | ~ placename(U,Z) | ~ hollywood_placename(U,Z) | ~ of(U,Z,Y) | ~ ssSkP2(X1,X2,U) | ~ group(U,X1) | ~ cheap(U,skf10(U,X3)) | ~ black(U,skf10(U,X3)) | ~ coat(U,skf10(U,X3)) | ~ group(U,X2) | ~ actual_world(U) ) ).
