...
fof(principia_op_implies_or,conjecture,op_implies_or ).
fof(principia_op_and,conjecture,op_and ).
fof(principia_op_equiv,conjecture,op_equiv ).
fof(principia_modus_ponens,conjecture,modus_ponens ).
fof(principia_r1,conjecture,r1 ).
fof(principia_r2,conjecture,r2 ).
fof(principia_r3,conjecture,r3 ).
fof(principia_r4,conjecture,r4 ).
fof(principia_r5,conjecture,r5 ).
