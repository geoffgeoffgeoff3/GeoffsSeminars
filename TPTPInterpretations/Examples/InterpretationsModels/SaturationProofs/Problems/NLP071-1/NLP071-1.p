...
fof(clause70,conjecture,actual_world(skc4) ).
fof(clause71,conjecture,man(skc4,skc7) ).
fof(clause72,conjecture,male(skc4,skc6) ).
fof(clause73,conjecture,six(skc4,skc5) ).
fof(clause74,conjecture,group(skc4,skc5) ).
fof(clause75,conjecture,! [U] : ( ~ member(skc4,U,skc5) | shot(skc4,U) ) ).
fof(clause76,conjecture,! [U] : ! [V] : ( ~ member(skc4,U,skc5) | ~ cannon(skc4,U) | ~ of(skc4,U,skc6) | fire(skc4,skf8(V)) ) ).
fof(clause77,conjecture,! [U] : ! [V] : ( ~ member(skc4,U,skc5) | ~ cannon(skc4,U) | ~ of(skc4,U,skc6) | nonreflexive(skc4,skf8(V)) ) ).
fof(clause78,conjecture,! [U] : ! [V] : ( ~ member(skc4,U,skc5) | ~ cannon(skc4,U) | ~ of(skc4,U,skc6) | present(skc4,skf8(V)) ) ).
fof(clause79,conjecture,! [U] : ! [V] : ( ~ member(skc4,U,skc5) | ~ cannon(skc4,U) | ~ of(skc4,U,skc6) | event(skc4,skf8(V)) ) ).
fof(clause80,conjecture,! [U] : ( ~ member(skc4,U,skc5) | ~ cannon(skc4,U) | ~ of(skc4,U,skc6) | from_loc(skc4,skf8(U),U) ) ).
fof(clause81,conjecture,! [U] : ( ~ member(skc4,U,skc5) | ~ cannon(skc4,U) | ~ of(skc4,U,skc6) | patient(skc4,skf8(U),U) ) ).
fof(clause82,conjecture,! [U] : ! [V] : ( ~ member(skc4,U,skc5) | ~ cannon(skc4,U) | ~ of(skc4,U,skc6) | agent(skc4,skf8(V),skc7) ) ).
