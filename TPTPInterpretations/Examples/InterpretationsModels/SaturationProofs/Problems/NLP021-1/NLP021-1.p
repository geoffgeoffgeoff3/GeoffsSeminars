...
fof(clause48,conjecture,city(skc13) ).
fof(clause49,conjecture,hollywood(skc13) ).
fof(clause50,conjecture,event(skc12) ).
fof(clause51,conjecture,lonely(skc11) ).
fof(clause52,conjecture,way(skc11) ).
fof(clause53,conjecture,street(skc11) ).
fof(clause54,conjecture,seat(skc9) ).
fof(clause55,conjecture,furniture(skc9) ).
fof(clause56,conjecture,front(skc9) ).
fof(clause57,conjecture,young(skc8) ).
fof(clause58,conjecture,man(skc8) ).
fof(clause59,conjecture,fellow(skc8) ).
fof(clause60,conjecture,fellow(skc7) ).
fof(clause61,conjecture,man(skc7) ).
fof(clause62,conjecture,young(skc7) ).
fof(clause63,conjecture,chevy(skc10) ).
fof(clause64,conjecture,car(skc10) ).
fof(clause65,conjecture,white(skc10) ).
fof(clause66,conjecture,dirty(skc10) ).
fof(clause67,conjecture,old(skc10) ).
fof(clause68,conjecture,in(skc12,skc13) ).
fof(clause69,conjecture,barrel(skc12,skc10) ).
