...
fof(clause37,conjecture,chevy(skc5,skc9) ).
fof(clause38,conjecture,placename(skc5,skc8) ).
fof(clause39,conjecture,hollywood_placename(skc5,skc8) ).
fof(clause40,conjecture,city(skc5,skc7) ).
fof(clause41,conjecture,street(skc5,skc7) ).
fof(clause42,conjecture,lonely(skc5,skc7) ).
fof(clause43,conjecture,white(skc5,skc9) ).
fof(clause44,conjecture,dirty(skc5,skc9) ).
fof(clause45,conjecture,old(skc5,skc9) ).
fof(clause46,conjecture,barrel(skc5,skc6) ).
fof(clause47,conjecture,present(skc5,skc6) ).
fof(clause48,conjecture,event(skc5,skc6) ).
fof(clause49,conjecture,of(skc5,skc8,skc7) ).
fof(clause50,conjecture,down(skc5,skc6,skc7) ).
fof(clause51,conjecture,in(skc5,skc6,skc7) ).
fof(clause52,conjecture,agent(skc5,skc6,skc9) ).
