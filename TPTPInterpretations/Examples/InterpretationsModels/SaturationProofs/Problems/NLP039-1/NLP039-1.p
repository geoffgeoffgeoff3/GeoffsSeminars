...
fof(clause42,conjecture,! [U] : ! [V] : ( ~ three(U,V) | member(U,skf18(V,U),V) ) ).
fof(clause43,conjecture,! [U] : ! [V] : ( ~ three(U,V) | member(U,skf16(V,U),V) ) ).
fof(clause44,conjecture,! [U] : ! [V] : ( ~ three(U,V) | member(U,skf14(V,U),V) ) ).
fof(clause45,conjecture,! [U] : ! [V] : ( skf18(U,V) != skf14(U,V) | ~ three(V,U) ) ).
fof(clause46,conjecture,! [U] : ! [V] : ( skf18(U,V) != skf16(U,V) | ~ three(V,U) ) ).
fof(clause47,conjecture,! [U] : ! [V] : ( skf16(U,V) != skf14(U,V) | ~ three(V,U) ) ).
fof(clause48,conjecture,! [U] : ! [V] : ! [W] : ( ~ member(U,V,W) | ~ three(U,W) | V = skf14(W,U) | V = skf16(W,U) | V = skf18(W,U) ) ).
fof(clause49,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ! [X3] : ( skf19(U,V,W,X,Y) != U | ~ member(Z,U,X1) | ~ member(Z,X2,X1) | ~ member(Z,X3,X1) | three(Z,X1) | U = X3 | U = X2 | X2 = X3 ) ).
...
fof(clause51,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ( skf19(U,V,W,X,Y) != W | ~ member(Z,U,X1) | ~ member(Z,V,X1) | ~ member(Z,W,X1) | three(Z,X1) | U = W | U = V | V = W ) ).
...
fof(clause54,conjecture,three(skc2,skc3) ).
fof(clause55,conjecture,group(skc2,skc3) ).
fof(clause56,conjecture,! [U] : ( ~ member(skc2,U,skc3) | young(skc2,U) ) ).
fof(clause57,conjecture,! [U] : ( ~ member(skc2,U,skc3) | guy(skc2,U) ) ).
fof(clause58,conjecture,! [U] : ! [V] : ( ~ member(skc2,U,skc3) | group(skc2,skf9(V)) ) ).
fof(clause59,conjecture,! [U] : ! [V] : ( ~ member(skc2,U,skc3) | table(skc2,skf11(V)) ) ).
fof(clause60,conjecture,! [U] : ! [V] : ! [W] : ( ~ member(skc2,U,skf9(V)) | ~ member(skc2,W,skc3) | hamburger(skc2,U) ) ).
fof(clause61,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc2,U,skf9(V)) | ~ member(skc2,V,skc3) | event(skc2,skf12(W,X)) ) ).
fof(clause62,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc2,U,skf9(V)) | ~ member(skc2,V,skc3) | present(skc2,skf12(W,X)) ) ).
fof(clause63,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc2,U,skf9(V)) | ~ member(skc2,V,skc3) | sit(skc2,skf12(W,X)) ) ).
fof(clause64,conjecture,! [U] : ! [V] : ( ~ member(skc2,U,skf9(V)) | ~ member(skc2,V,skc3) | agent(skc2,skf12(U,V),V) ) ).
fof(clause65,conjecture,! [U] : ! [V] : ! [W] : ( ~ member(skc2,U,skf9(V)) | ~ member(skc2,V,skc3) | with(skc2,skf12(U,W),U) ) ).
fof(clause66,conjecture,! [U] : ! [V] : ( ~ member(skc2,U,skf9(V)) | ~ member(skc2,V,skc3) | at(skc2,skf12(U,V),skf11(V)) ) ).
