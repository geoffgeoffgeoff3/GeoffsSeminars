...
fof(co1,conjecture,~(~ ( ? [U] : ( actual_world(U) & ? [V] : ? [W] : ? [X] : ( male(U,V) & man(U,V) & of(U,W,V) & cannon(U,W) & ! [Y] : ( member(U,Y,X) => ? [Z] : ( event(U,Z) & agent(U,Z,V) & patient(U,Z,Y) & present(U,Z) & nonreflexive(U,Z) & fire(U,Z) & from_loc(U,Z,W) ) ) & six(U,X) & group(U,X) & ! [X1] : ( member(U,X1,X) => shot(U,X1) ) ) ) & ~ ( ? [X2] : ( actual_world(X2) & ? [X3] : ? [V] : ? [W] : ? [X] : ? [X4] : ? [X5] : ? [X6] : ( male(X2,X3) & male(X2,V) & man(X2,V) & of(X2,W,V) & cannon(X2,W) & ! [Y] : ( member(X2,Y,X) => ? [Z] : ( event(X2,Z) & agent(X2,Z,V) & patient(X2,Z,Y) & present(X2,Z) & nonreflexive(X2,Z) & fire(X2,Z) & from_loc(X2,Z,W) ) ) & six(X2,X) & group(X2,X) & ! [X1] : ( member(X2,X1,X) => shot(X2,X1) ) & revenge(X2,X4) & cry(X2,X5) & event(X2,X6) & agent(X2,X6,X3) & patient(X2,X6,X5) & present(X2,X6) & nonreflexive(X2,X6) & scream(X2,X6) & of(X2,X6,X4) ) ) ) ) )).
