...
fof(clause36,conjecture,restaurant(skc2,skc3) ).
fof(clause37,conjecture,! [U] : ! [V] : ( ~ in(skc2,U,skc3) | ~ customer(skc2,U) | event(skc2,skf4(V)) ) ).
fof(clause38,conjecture,! [U] : ! [V] : ( ~ in(skc2,U,skc3) | ~ customer(skc2,U) | past(skc2,skf4(V)) ) ).
fof(clause39,conjecture,! [U] : ! [V] : ( ~ in(skc2,U,skc3) | ~ customer(skc2,U) | nonreflexive(skc2,skf4(V)) ) ).
fof(clause40,conjecture,! [U] : ! [V] : ( ~ in(skc2,U,skc3) | ~ customer(skc2,U) | see(skc2,skf4(V)) ) ).
fof(clause41,conjecture,! [U] : ! [V] : ( ~ in(skc2,U,skc3) | ~ customer(skc2,U) | coffee(skc2,skf6(V)) ) ).
fof(clause42,conjecture,! [U] : ! [V] : ( ~ in(skc2,U,skc3) | ~ customer(skc2,U) | drink(skc2,skf5(V)) ) ).
fof(clause43,conjecture,! [U] : ! [V] : ( ~ in(skc2,U,skc3) | ~ customer(skc2,U) | nonreflexive(skc2,skf5(V)) ) ).
fof(clause44,conjecture,! [U] : ! [V] : ( ~ in(skc2,U,skc3) | ~ customer(skc2,U) | past(skc2,skf5(V)) ) ).
fof(clause45,conjecture,! [U] : ! [V] : ( ~ in(skc2,U,skc3) | ~ customer(skc2,U) | event(skc2,skf5(V)) ) ).
fof(clause46,conjecture,! [U] : ! [V] : ( ~ in(skc2,U,skc3) | ~ customer(skc2,U) | human_person(skc2,skf7(V)) ) ).
fof(clause47,conjecture,! [U] : ( ~ in(skc2,U,skc3) | ~ customer(skc2,U) | agent(skc2,skf4(U),U) ) ).
fof(clause48,conjecture,! [U] : ! [V] : ( ~ in(skc2,U,skc3) | ~ customer(skc2,U) | patient(skc2,skf5(V),skf6(V)) ) ).
fof(clause49,conjecture,! [U] : ! [V] : ( ~ in(skc2,U,skc3) | ~ customer(skc2,U) | agent(skc2,skf5(V),skf7(V)) ) ).
fof(clause50,conjecture,! [U] : ! [V] : ( ~ in(skc2,U,skc3) | ~ customer(skc2,U) | patient(skc2,skf4(V),skf7(V)) ) ).
