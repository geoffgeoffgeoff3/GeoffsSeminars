...
fof(km5_op_possibly,conjecture,op_possibly ).
fof(km5_necessitation,conjecture,necessitation ).
fof(km5_axiom_K,conjecture,axiom_K ).
fof(km5_axiom_M,conjecture,axiom_M ).
