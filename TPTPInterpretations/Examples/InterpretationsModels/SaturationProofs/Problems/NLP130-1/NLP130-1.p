...
fof(clause3,conjecture,ssSkC0 | event(skc42,skc44) ).
fof(clause4,conjecture,ssSkC0 | present(skc42,skc44) ).
fof(clause5,conjecture,ssSkC0 | barrel(skc42,skc44) ).
fof(clause6,conjecture,ssSkC0 | old(skc42,skc47) ).
fof(clause7,conjecture,ssSkC0 | dirty(skc42,skc47) ).
fof(clause8,conjecture,ssSkC0 | white(skc42,skc47) ).
fof(clause9,conjecture,ssSkC0 | chevy(skc42,skc47) ).
fof(clause10,conjecture,ssSkC0 | lonely(skc42,skc45) ).
fof(clause11,conjecture,ssSkC0 | street(skc42,skc45) ).
fof(clause12,conjecture,ssSkC0 | city(skc42,skc45) ).
fof(clause13,conjecture,ssSkC0 | hollywood_placename(skc42,skc46) ).
fof(clause14,conjecture,ssSkC0 | placename(skc42,skc46) ).
...
fof(clause33,conjecture,ssSkC0 | agent(skc42,skc44,skc47) ).
fof(clause34,conjecture,ssSkC0 | in(skc42,skc44,skc45) ).
fof(clause35,conjecture,ssSkC0 | down(skc42,skc44,skc45) ).
fof(clause36,conjecture,ssSkC0 | of(skc42,skc46,skc45) ).
...
fof(clause57,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ( ~ event(U,V) | ~ present(U,V) | ~ barrel(U,V) | ~ agent(U,V,W) | ~ old(U,W) | ~ dirty(U,W) | ~ white(U,W) | ~ chevy(U,W) | ~ in(U,V,X) | ~ down(U,V,X) | ~ lonely(U,X) | ~ street(U,X) | ~ city(U,X) | ~ of(U,Y,X) | ~ hollywood_placename(U,Y) | ~ placename(U,Y) | ~ group(U,Z) | ~ two(U,Z) | ~ ssSkP0(Z,U) | ~ actual_world(U) | ssSkC0 | member(U,skf21(U,Z),Z) ) ).
fof(clause58,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ( ~ event(U,V) | ~ present(U,V) | ~ barrel(U,V) | ~ agent(U,V,W) | ~ old(U,W) | ~ dirty(U,W) | ~ white(U,W) | ~ chevy(U,W) | ~ in(U,V,X) | ~ down(U,V,X) | ~ lonely(U,X) | ~ street(U,X) | ~ city(U,X) | ~ of(U,Y,X) | ~ hollywood_placename(U,Y) | ~ placename(U,Y) | ~ group(U,Z) | ~ two(U,Z) | ~ ssSkP1(Z,U) | ~ actual_world(U) | ~ ssSkC0 | member(U,skf9(U,Z),Z) ) ).
fof(clause59,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ( ~ event(U,V) | ~ present(U,V) | ~ barrel(U,V) | ~ agent(U,V,W) | ~ old(U,W) | ~ dirty(U,W) | ~ white(U,W) | ~ chevy(U,W) | ~ in(U,V,X) | ~ down(U,V,X) | ~ lonely(U,X) | ~ street(U,X) | ~ city(U,X) | ~ of(U,Y,X) | ~ hollywood_placename(U,Y) | ~ placename(U,Y) | ~ young(U,skf21(U,Z)) | ~ fellow(U,skf21(U,Z)) | ~ group(U,X1) | ~ two(U,X1) | ~ ssSkP0(X1,U) | ~ actual_world(U) | ssSkC0 ) ).
fof(clause60,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ( ~ event(U,V) | ~ present(U,V) | ~ barrel(U,V) | ~ agent(U,V,W) | ~ old(U,W) | ~ dirty(U,W) | ~ white(U,W) | ~ chevy(U,W) | ~ in(U,V,X) | ~ down(U,V,X) | ~ lonely(U,X) | ~ street(U,X) | ~ city(U,X) | ~ of(U,Y,X) | ~ hollywood_placename(U,Y) | ~ placename(U,Y) | ~ young(U,skf9(U,Z)) | ~ fellow(U,skf9(U,Z)) | ~ group(U,X1) | ~ two(U,X1) | ~ ssSkP1(X1,U) | ~ actual_world(U) | ~ ssSkC0 ) ).
