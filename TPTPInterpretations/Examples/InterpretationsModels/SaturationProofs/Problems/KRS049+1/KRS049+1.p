...
fof(axiom_5,conjecture,! [X] : ( ca_Ax4(X) <=> ( ! [Y] : ( rinvR(X,Y) => ca_Cx2(Y) ) & cp1(X) ) ) ).
fof(axiom_6,conjecture,! [X] : ( ca_Cx2(X) <=> ~ ( ? [Y] : ra_Px2(X,Y) ) ) ).
fof(axiom_7,conjecture,! [X] : ( ca_Cx2xcomp(X) <=> ( ca_Cx3(X) & cp1(X) ) ) ).
...
fof(axiom_13,conjecture,! [X] : ! [Y] : ! [Z] : ( ( rf(X,Y) & rf(X,Z) ) => Y = Z ) ).
...
fof(axiom_17,conjecture,cSatisfiable(i2003_11_14_17_16_36130) ).
