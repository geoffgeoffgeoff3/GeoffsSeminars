...
fof(clause73,conjecture,event(skc14,skc24) ).
fof(clause74,conjecture,man(skc13,skc23) ).
fof(clause75,conjecture,present(skc14,skc24) ).
fof(clause76,conjecture,smoke(skc14,skc24) ).
fof(clause77,conjecture,jules_forename(skc13,skc25) ).
fof(clause78,conjecture,forename(skc13,skc25) ).
fof(clause79,conjecture,forename(skc13,skc22) ).
fof(clause80,conjecture,vincent_forename(skc13,skc22) ).
fof(clause81,conjecture,event(skc13,skc21) ).
fof(clause82,conjecture,present(skc13,skc21) ).
fof(clause83,conjecture,think_believe_consider(skc13,skc21) ).
fof(clause84,conjecture,forename(skc13,skc19) ).
fof(clause85,conjecture,jules_forename(skc13,skc18) ).
fof(clause86,conjecture,forename(skc13,skc18) ).
fof(clause87,conjecture,man(skc13,skc17) ).
fof(clause88,conjecture,vincent_forename(skc13,skc19) ).
...
fof(clause93,conjecture,accessible_world(skc13,skc20) ).
fof(clause94,conjecture,proposition(skc13,skc20) ).
fof(clause95,conjecture,proposition(skc13,skc14) ).
fof(clause96,conjecture,accessible_world(skc13,skc14) ).
fof(clause97,conjecture,of(skc13,skc25,skc23) ).
fof(clause98,conjecture,of(skc13,skc22,skc23) ).
fof(clause99,conjecture,agent(skc13,skc21,skc23) ).
fof(clause100,conjecture,agent(skc14,skc24,skc23) ).
fof(clause101,conjecture,theme(skc13,skc21,skc20) ).
fof(clause102,conjecture,of(skc13,skc18,skc17) ).
fof(clause103,conjecture,agent(skc13,skc15,skc17) ).
fof(clause104,conjecture,of(skc13,skc19,skc17) ).
fof(clause105,conjecture,theme(skc13,skc15,skc14) ).
fof(clause106,conjecture,be(skc13,skc16,skc17,skc17) ).
fof(clause107,conjecture,! [U] : ! [V] : ( ~ man(skc20,U) | smoke(skc20,skf1(V)) ) ).
fof(clause108,conjecture,! [U] : ! [V] : ( ~ man(skc20,U) | present(skc20,skf1(V)) ) ).
fof(clause109,conjecture,! [U] : ! [V] : ( ~ man(skc20,U) | event(skc20,skf1(V)) ) ).
fof(clause110,conjecture,! [U] : ( ~ man(skc20,U) | agent(skc20,skf1(U),U) ) ).
