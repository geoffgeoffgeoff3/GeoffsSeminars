...
fof(clause80,conjecture,jules_forename(skc14,skc23) = true ).
fof(clause81,conjecture,man(skc14,skc22) = true ).
fof(clause82,conjecture,event(skc15,skc20) = true ).
fof(clause83,conjecture,jules_forename(skc14,skc19) = true ).
fof(clause84,conjecture,forename(skc14,skc19) = true ).
fof(clause85,conjecture,present(skc15,skc20) = true ).
fof(clause86,conjecture,smoke(skc15,skc20) = true ).
...
fof(clause95,conjecture,state(skc14,skc21) = true ).
...
fof(clause101,conjecture,of(skc14,skc23,skc22) = true ).
fof(clause102,conjecture,of(skc14,skc19,skc18) = true ).
fof(clause103,conjecture,agent(skc15,skc20,skc18) = true ).
fof(clause104,conjecture,agent(skc14,skc16,skc18) = true ).
fof(clause105,conjecture,of(skc14,skc17,skc18) = true ).
fof(clause106,conjecture,theme(skc14,skc16,skc15) = true ).
fof(clause107,conjecture,be(skc14,skc21,skc22,skc22) = true ).
