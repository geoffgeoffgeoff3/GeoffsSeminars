...
fof(clause77,conjecture,present(skc9,skc15) = true ).
fof(clause78,conjecture,think_believe_consider(skc9,skc15) = true ).
fof(clause79,conjecture,man(skc9,skc13) = true ).
fof(clause80,conjecture,forename(skc9,skc12) = true ).
fof(clause81,conjecture,jules_forename(skc9,skc12) = true ).
fof(clause82,conjecture,man(skc9,skc11) = true ).
fof(clause83,conjecture,state(skc9,skc10) = true ).
fof(clause84,conjecture,accessible_world(skc9,skc14) = true ).
fof(clause85,conjecture,proposition(skc9,skc14) = true ).
fof(clause86,conjecture,of(skc9,skc16,skc17) = true ).
fof(clause87,conjecture,agent(skc9,skc15,skc17) = true ).
fof(clause88,conjecture,theme(skc9,skc15,skc14) = true ).
fof(clause89,conjecture,of(skc9,skc12,skc13) = true ).
fof(clause90,conjecture,be(skc9,skc10,skc13,skc11) = true ).
fof(clause91,conjecture,! [U] : ! [V] : ifeq2(man(skc14,U),true,smoke(skc14,skf1(V)),true) = true ).
fof(clause92,conjecture,! [U] : ! [V] : ifeq2(man(skc14,U),true,present(skc14,skf1(V)),true) = true ).
fof(clause93,conjecture,! [U] : ! [V] : ifeq2(man(skc14,U),true,event(skc14,skf1(V)),true) = true ).
fof(clause94,conjecture,! [U] : ifeq2(man(skc14,U),true,agent(skc14,skf1(U),U),true) = true ).
