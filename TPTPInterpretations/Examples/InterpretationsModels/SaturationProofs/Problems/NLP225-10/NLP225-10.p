...
fof(clause76,conjecture,vincent_forename(skc8,skc13) = true ).
fof(clause77,conjecture,forename(skc8,skc13) = true ).
fof(clause78,conjecture,think_believe_consider(skc8,skc12) = true ).
fof(clause79,conjecture,present(skc8,skc12) = true ).
fof(clause80,conjecture,event(skc8,skc12) = true ).
fof(clause81,conjecture,proposition(skc8,skc11) = true ).
fof(clause82,conjecture,accessible_world(skc8,skc11) = true ).
fof(clause83,conjecture,man(skc8,skc10) = true ).
fof(clause84,conjecture,state(skc8,skc9) = true ).
fof(clause85,conjecture,of(skc8,skc15,skc14) = true ).
fof(clause86,conjecture,agent(skc8,skc12,skc14) = true ).
fof(clause87,conjecture,of(skc8,skc13,skc14) = true ).
fof(clause88,conjecture,theme(skc8,skc12,skc11) = true ).
fof(clause89,conjecture,be(skc8,skc9,skc14,skc10) = true ).
...
fof(clause92,conjecture,! [U] : ! [V] : ifeq2(man(skc11,U),true,event(skc11,skf1(V)),true) = true ).
fof(clause93,conjecture,! [U] : ifeq2(man(skc11,U),true,agent(skc11,skf1(U),U),true) = true ).
