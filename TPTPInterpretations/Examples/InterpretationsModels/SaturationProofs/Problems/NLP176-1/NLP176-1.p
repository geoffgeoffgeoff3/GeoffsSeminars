...
fof(clause75,conjecture,hollywood_placename(skc9,skc17) ).
fof(clause76,conjecture,placename(skc9,skc17) ).
fof(clause77,conjecture,street(skc9,skc15) ).
fof(clause78,conjecture,lonely(skc9,skc15) ).
fof(clause79,conjecture,group(skc9,skc11) ).
fof(clause80,conjecture,group(skc9,skc10) ).
fof(clause81,conjecture,barrel(skc9,skc14) ).
fof(clause82,conjecture,present(skc9,skc14) ).
fof(clause83,conjecture,event(skc9,skc14) ).
fof(clause84,conjecture,old(skc9,skc16) ).
fof(clause85,conjecture,dirty(skc9,skc16) ).
fof(clause86,conjecture,white(skc9,skc16) ).
fof(clause87,conjecture,chevy(skc9,skc16) ).
fof(clause88,conjecture,city(skc9,skc16) ).
fof(clause89,conjecture,two(skc9,skc18) ).
fof(clause90,conjecture,group(skc9,skc18) ).
fof(clause91,conjecture,of(skc9,skc17,skc16) ).
fof(clause92,conjecture,down(skc9,skc14,skc15) ).
fof(clause93,conjecture,in(skc9,skc14,skc16) ).
fof(clause94,conjecture,agent(skc9,skc14,skc16) ).
