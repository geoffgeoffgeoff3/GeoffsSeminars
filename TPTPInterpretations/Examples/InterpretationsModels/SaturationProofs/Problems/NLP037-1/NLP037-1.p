...
fof(clause56,conjecture,! [U] : ( ~ member(skc3,U,skc4) | hamburger(skc3,U) ) ).
fof(clause57,conjecture,! [U] : ! [V] : ( ~ member(skc3,U,skc4) | group(skc3,skf8(V)) ) ).
fof(clause58,conjecture,! [U] : ! [V] : ( ~ member(skc3,U,skc4) | three(skc3,skf8(V)) ) ).
fof(clause59,conjecture,! [U] : ! [V] : ! [W] : ( ~ member(skc3,U,skf8(V)) | ~ member(skc3,W,skc4) | guy(skc3,U) ) ).
fof(clause60,conjecture,! [U] : ! [V] : ! [W] : ( ~ member(skc3,U,skf8(V)) | ~ member(skc3,W,skc4) | young(skc3,U) ) ).
...
fof(clause64,conjecture,! [U] : ! [V] : ! [W] : ( ~ member(skc3,U,skf8(V)) | ~ member(skc3,V,skc4) | agent(skc3,skf9(U,W),U) ) ).
fof(clause65,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc3,U,skf8(V)) | ~ member(skc3,V,skc4) | at(skc3,skf9(W,X),skc5) ) ).
fof(clause66,conjecture,! [U] : ! [V] : ( ~ member(skc3,U,skf8(V)) | ~ member(skc3,V,skc4) | with(skc3,skf9(U,V),V) ) ).
