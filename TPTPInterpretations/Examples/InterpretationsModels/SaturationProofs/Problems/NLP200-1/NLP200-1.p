...
fof(clause78,conjecture,actual_world(skc13) ).
fof(clause79,conjecture,chevy(skc13,skc29) ).
fof(clause80,conjecture,placename(skc13,skc28) ).
fof(clause81,conjecture,hollywood_placename(skc13,skc28) ).
fof(clause82,conjecture,city(skc13,skc27) ).
fof(clause83,conjecture,street(skc13,skc27) ).
fof(clause84,conjecture,lonely(skc13,skc27) ).
fof(clause85,conjecture,frontseat(skc13,skc21) ).
fof(clause86,conjecture,two(skc13,skc20) ).
fof(clause87,conjecture,group(skc13,skc20) ).
fof(clause88,conjecture,wheel(skc13,skc18) ).
fof(clause89,conjecture,man(skc13,skc17) ).
fof(clause90,conjecture,forename(skc13,skc16) ).
fof(clause91,conjecture,jules_forename(skc13,skc16) ).
fof(clause92,conjecture,state(skc13,skc15) ).
fof(clause93,conjecture,group(skc13,skc19) ).
fof(clause94,conjecture,white(skc13,skc29) ).
fof(clause95,conjecture,dirty(skc13,skc29) ).
fof(clause96,conjecture,old(skc13,skc29) ).
fof(clause97,conjecture,barrel(skc13,skc26) ).
fof(clause98,conjecture,present(skc13,skc26) ).
fof(clause99,conjecture,event(skc13,skc26) ).
fof(clause100,conjecture,of(skc13,skc28,skc27) ).
fof(clause101,conjecture,down(skc13,skc26,skc27) ).
fof(clause102,conjecture,in(skc13,skc26,skc27) ).
fof(clause103,conjecture,of(skc13,skc16,skc17) ).
fof(clause104,conjecture,behind(skc13,skc14,skc18) ).
fof(clause105,conjecture,agent(skc13,skc26,skc29) ).
fof(clause106,conjecture,be(skc13,skc15,skc17,skc14) ).
fof(clause107,conjecture,! [U] : ( ~ member(skc13,U,skc20) | young(skc13,U) ) ).
fof(clause108,conjecture,! [U] : ( ~ member(skc13,U,skc20) | fellow(skc13,U) ) ).
fof(clause109,conjecture,! [U] : ( ~ member(skc13,U,skc19) | cheap(skc13,U) ) ).
fof(clause110,conjecture,! [U] : ( ~ member(skc13,U,skc19) | black(skc13,U) ) ).
fof(clause111,conjecture,! [U] : ( ~ member(skc13,U,skc19) | coat(skc13,U) ) ).
fof(clause112,conjecture,! [U] : ! [V] : ( ~ member(skc13,U,skc20) | state(skc13,skf7(V)) ) ).
fof(clause113,conjecture,! [U] : ! [V] : ( ~ member(skc13,U,skc20) | in(skc13,skf6(V),skc21) ) ).
fof(clause114,conjecture,! [U] : ( ~ member(skc13,U,skc20) | be(skc13,skf7(U),U,skf6(U)) ) ).
fof(clause115,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc13,U,skc20) | ~ member(skc13,V,skc19) | event(skc13,skf8(W,X)) ) ).
fof(clause116,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc13,U,skc20) | ~ member(skc13,V,skc19) | present(skc13,skf8(W,X)) ) ).
fof(clause117,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc13,U,skc20) | ~ member(skc13,V,skc19) | nonreflexive(skc13,skf8(W,X)) ) ).
fof(clause118,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ member(skc13,U,skc20) | ~ member(skc13,V,skc19) | wear(skc13,skf8(W,X)) ) ).
fof(clause119,conjecture,! [U] : ! [V] : ! [W] : ( ~ member(skc13,U,skc20) | ~ member(skc13,V,skc19) | agent(skc13,skf8(U,W),U) ) ).
fof(clause120,conjecture,! [U] : ! [V] : ( ~ member(skc13,U,skc20) | ~ member(skc13,V,skc19) | patient(skc13,skf8(U,V),V) ) ).
