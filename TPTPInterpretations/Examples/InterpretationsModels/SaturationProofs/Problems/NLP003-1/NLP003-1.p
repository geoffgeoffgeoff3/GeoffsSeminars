...
fof(clause42,conjecture,chevy(skc5) ).
fof(clause43,conjecture,car(skc5) ).
fof(clause44,conjecture,white(skc5) ).
fof(clause45,conjecture,dirty(skc5) ).
fof(clause46,conjecture,old(skc5) ).
fof(clause47,conjecture,lonely(skc4) ).
fof(clause48,conjecture,way(skc4) ).
fof(clause49,conjecture,street(skc4) ).
fof(clause50,conjecture,in(skc6,skc7) ).
fof(clause51,conjecture,down(skc6,skc4) ).
fof(clause52,conjecture,barrel(skc6,skc5) ).
