...
fof(clause79,conjecture,man(skc13,skc19) = true ).
fof(clause80,conjecture,present(skc14,skc21) = true ).
fof(clause81,conjecture,smoke(skc14,skc21) = true ).
...
fof(clause96,conjecture,state(skc13,skc24) = true ).
fof(clause97,conjecture,of(skc13,skc26,skc25) = true ).
fof(clause98,conjecture,of(skc13,skc22,skc19) = true ).
fof(clause99,conjecture,of(skc13,skc20,skc19) = true ).
fof(clause100,conjecture,of(skc13,skc18,skc19) = true ).
fof(clause101,conjecture,agent(skc13,skc17,skc19) = true ).
fof(clause102,conjecture,agent(skc13,skc15,skc19) = true ).
fof(clause103,conjecture,agent(skc14,skc21,skc19) = true ).
