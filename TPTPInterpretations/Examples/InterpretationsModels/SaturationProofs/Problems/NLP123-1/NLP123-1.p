...
fof(clause15,conjecture,~ ssSkC0 | old(skc11,skc16) ).
fof(clause16,conjecture,~ ssSkC0 | dirty(skc11,skc16) ).
fof(clause17,conjecture,~ ssSkC0 | white(skc11,skc16) ).
fof(clause18,conjecture,~ ssSkC0 | chevy(skc11,skc16) ).
fof(clause19,conjecture,~ ssSkC0 | barrel(skc11,skc12) ).
fof(clause20,conjecture,~ ssSkC0 | present(skc11,skc12) ).
fof(clause21,conjecture,~ ssSkC0 | event(skc11,skc12) ).
fof(clause22,conjecture,~ ssSkC0 | hollywood_placename(skc11,skc14) ).
fof(clause23,conjecture,~ ssSkC0 | placename(skc11,skc14) ).
fof(clause24,conjecture,~ ssSkC0 | city(skc11,skc15) ).
fof(clause25,conjecture,~ ssSkC0 | street(skc11,skc13) ).
fof(clause26,conjecture,~ ssSkC0 | lonely(skc11,skc13) ).
...
fof(clause31,conjecture,~ ssSkC0 | agent(skc11,skc12,skc16) ).
fof(clause32,conjecture,~ ssSkC0 | in(skc11,skc12,skc15) ).
fof(clause33,conjecture,~ ssSkC0 | of(skc11,skc14,skc15) ).
fof(clause34,conjecture,~ ssSkC0 | down(skc11,skc12,skc13) ).
fof(clause35,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ( ~ agent(U,V,W) | ~ old(U,W) | ~ dirty(U,W) | ~ white(U,W) | ~ chevy(U,W) | ~ barrel(U,V) | ~ present(U,V) | ~ event(U,V) | ~ hollywood_placename(U,X) | ~ placename(U,X) | ~ in(U,V,Y) | ~ city(U,Y) | ~ of(U,X,Y) | ~ street(U,Z) | ~ lonely(U,Z) | ~ down(U,V,Z) | ~ actual_world(U) | ssSkC0 ) ).
