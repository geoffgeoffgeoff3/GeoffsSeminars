fof(rule_1,conjecture,! [Z] : ! [Y] : ! [X] : top(f(f(f(f(Z,a),a),Y),f(X,a)),f(f(X,f(f(f(Y,a),a),a)),Z)) ).
fof(prove,conjecture,! [X] : seq(succ(succ(succ(succ(succ(succ(succ(succ(zero)))))))),X,X) ).
