...
fof(clause74,conjecture,frontseat(skc7,skc13) ).
fof(clause75,conjecture,city(skc7,skc12) ).
fof(clause76,conjecture,lonely(skc7,skc10) ).
fof(clause77,conjecture,street(skc7,skc10) ).
fof(clause78,conjecture,placename(skc7,skc11) ).
fof(clause79,conjecture,hollywood_placename(skc7,skc11) ).
fof(clause80,conjecture,event(skc7,skc9) ).
fof(clause81,conjecture,present(skc7,skc9) ).
fof(clause82,conjecture,barrel(skc7,skc9) ).
fof(clause83,conjecture,chevy(skc7,skc13) ).
...
fof(clause92,conjecture,down(skc7,skc9,skc10) ).
fof(clause93,conjecture,agent(skc7,skc9,skc13) ).
fof(clause94,conjecture,ssSkP1(skc13,skc8,skc7) ).
