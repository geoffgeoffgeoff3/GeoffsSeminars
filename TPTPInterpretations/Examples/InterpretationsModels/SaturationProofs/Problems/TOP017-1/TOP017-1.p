...
fof(problem_12_154,conjecture,topological_space(cx,ct) ).
fof(problem_12_155,conjecture,subset_sets(a,cx) ).
fof(problem_12_156,conjecture,equal_sets(boundary(a,cx,ct),empty_set) | open(a,cx,ct) ).
fof(problem_12_157,conjecture,equal_sets(boundary(a,cx,ct),empty_set) | closed(a,cx,ct) ).
fof(problem_12_158,conjecture,~ equal_sets(boundary(a,cx,ct),empty_set) | ~ open(a,cx,ct) | ~ closed(a,cx,ct) ).
