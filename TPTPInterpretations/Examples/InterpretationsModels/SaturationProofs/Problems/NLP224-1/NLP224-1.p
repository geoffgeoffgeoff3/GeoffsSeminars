...
fof(clause72,conjecture,actual_world(skc9) ).
fof(clause73,conjecture,man(skc9,skc17) ).
fof(clause74,conjecture,forename(skc9,skc16) ).
fof(clause75,conjecture,vincent_forename(skc9,skc16) ).
fof(clause76,conjecture,event(skc9,skc15) ).
fof(clause77,conjecture,present(skc9,skc15) ).
fof(clause78,conjecture,think_believe_consider(skc9,skc15) ).
fof(clause79,conjecture,man(skc9,skc13) ).
fof(clause80,conjecture,forename(skc9,skc12) ).
fof(clause81,conjecture,jules_forename(skc9,skc12) ).
fof(clause82,conjecture,man(skc9,skc11) ).
fof(clause83,conjecture,state(skc9,skc10) ).
fof(clause84,conjecture,accessible_world(skc9,skc14) ).
fof(clause85,conjecture,proposition(skc9,skc14) ).
fof(clause86,conjecture,of(skc9,skc16,skc17) ).
fof(clause87,conjecture,agent(skc9,skc15,skc17) ).
fof(clause88,conjecture,theme(skc9,skc15,skc14) ).
fof(clause89,conjecture,of(skc9,skc12,skc13) ).
fof(clause90,conjecture,be(skc9,skc10,skc13,skc11) ).
fof(clause91,conjecture,! [U] : ! [V] : ( ~ man(skc14,U) | smoke(skc14,skf1(V)) ) ).
fof(clause92,conjecture,! [U] : ! [V] : ( ~ man(skc14,U) | present(skc14,skf1(V)) ) ).
fof(clause93,conjecture,! [U] : ! [V] : ( ~ man(skc14,U) | event(skc14,skf1(V)) ) ).
fof(clause94,conjecture,! [U] : ( ~ man(skc14,U) | agent(skc14,skf1(U),U) ) ).
