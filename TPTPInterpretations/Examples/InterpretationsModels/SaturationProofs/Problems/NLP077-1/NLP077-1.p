...
fof(clause71,conjecture,six(skc2,skc3) ).
fof(clause72,conjecture,group(skc2,skc3) ).
fof(clause73,conjecture,! [U] : ( ~ member(skc2,U,skc3) | shot(skc2,U) ) ).
fof(clause74,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ cannon(skc2,U) | ~ member(skc2,U,skc3) | ~ of(skc2,U,V) | ~ man(skc2,V) | ~ male(skc2,V) | fire(skc2,skf8(W,X)) ) ).
fof(clause75,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ cannon(skc2,U) | ~ member(skc2,U,skc3) | ~ of(skc2,U,V) | ~ man(skc2,V) | ~ male(skc2,V) | nonreflexive(skc2,skf8(W,X)) ) ).
fof(clause76,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ cannon(skc2,U) | ~ member(skc2,U,skc3) | ~ of(skc2,U,V) | ~ man(skc2,V) | ~ male(skc2,V) | present(skc2,skf8(W,X)) ) ).
fof(clause77,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ( ~ cannon(skc2,U) | ~ member(skc2,U,skc3) | ~ of(skc2,U,V) | ~ man(skc2,V) | ~ male(skc2,V) | event(skc2,skf8(W,X)) ) ).
fof(clause78,conjecture,! [U] : ! [V] : ( ~ cannon(skc2,U) | ~ member(skc2,U,skc3) | ~ of(skc2,U,V) | ~ man(skc2,V) | ~ male(skc2,V) | patient(skc2,skf8(V,U),U) ) ).
fof(clause79,conjecture,! [U] : ! [V] : ! [W] : ( ~ cannon(skc2,U) | ~ member(skc2,U,skc3) | ~ of(skc2,U,V) | ~ man(skc2,V) | ~ male(skc2,V) | agent(skc2,skf8(V,W),V) ) ).
fof(clause80,conjecture,! [U] : ! [V] : ( ~ cannon(skc2,U) | ~ member(skc2,U,skc3) | ~ of(skc2,U,V) | ~ man(skc2,V) | ~ male(skc2,V) | from_loc(skc2,skf8(V,U),U) ) ).
