...
fof(clause94,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ! [X3] : ! [X4] : ! [X5] : ! [X6] : ( ~ state(U,V) | ~ man(U,W) | ~ be(U,V,W,W) | ~ forename(U,X) | ~ jules_forename(U,X) | ~ of(U,X,W) | ~ accessible_world(U,Y) | ~ proposition(U,Y) | ~ proposition(U,Z) | ~ accessible_world(U,Z) | ~ think_believe_consider(U,X1) | ~ present(U,X1) | ~ event(U,X1) | ~ theme(U,X1,Z) | ~ forename(U,X2) | ~ jules_forename(U,X2) | ~ of(U,X2,X3) | ~ smoke(Y,X4) | ~ present(Y,X4) | ~ agent(Y,X4,X3) | ~ event(Y,X4) | ~ agent(U,X5,X3) | ~ agent(U,X1,X3) | ~ man(U,X3) | ~ of(U,X6,X3) | ~ vincent_forename(U,X6) | ~ forename(U,X6) | ~ theme(U,X5,Y) | ~ event(U,X5) | ~ present(U,X5) | ~ think_believe_consider(U,X5) | ~ actual_world(U) | man(Z,skf4(Z)) ) ).
fof(clause95,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ! [X3] : ! [X4] : ! [X5] : ! [X6] : ! [X7] : ( ~ state(U,V) | ~ man(U,W) | ~ be(U,V,W,W) | ~ forename(U,X) | ~ jules_forename(U,X) | ~ of(U,X,W) | ~ accessible_world(U,Y) | ~ proposition(U,Y) | ~ proposition(U,Z) | ~ accessible_world(U,Z) | ~ smoke(Z,X1) | ~ present(Z,X1) | ~ agent(Z,X1,skf4(Z)) | ~ event(Z,X1) | ~ think_believe_consider(U,X2) | ~ present(U,X2) | ~ event(U,X2) | ~ theme(U,X2,Z) | ~ forename(U,X3) | ~ jules_forename(U,X3) | ~ of(U,X3,X4) | ~ smoke(Y,X5) | ~ present(Y,X5) | ~ agent(Y,X5,X4) | ~ event(Y,X5) | ~ agent(U,X6,X4) | ~ agent(U,X2,X4) | ~ man(U,X4) | ~ of(U,X7,X4) | ~ vincent_forename(U,X7) | ~ forename(U,X7) | ~ theme(U,X6,Y) | ~ event(U,X6) | ~ present(U,X6) | ~ think_believe_consider(U,X6) | ~ actual_world(U) ) ).
