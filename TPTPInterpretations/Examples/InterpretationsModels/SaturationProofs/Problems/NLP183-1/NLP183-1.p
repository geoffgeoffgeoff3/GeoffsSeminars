...
fof(clause74,conjecture,city(skc8,skc14) ).
fof(clause75,conjecture,street(skc8,skc12) ).
fof(clause76,conjecture,lonely(skc8,skc12) ).
fof(clause77,conjecture,frontseat(skc8,skc10) ).
fof(clause78,conjecture,two(skc8,skc9) ).
fof(clause79,conjecture,group(skc8,skc9) ).
fof(clause80,conjecture,ssSkP0(skc9,skc8) ).
fof(clause81,conjecture,hollywood_placename(skc8,skc13) ).
fof(clause82,conjecture,placename(skc8,skc13) ).
fof(clause83,conjecture,barrel(skc8,skc11) ).
fof(clause84,conjecture,present(skc8,skc11) ).
fof(clause85,conjecture,event(skc8,skc11) ).
fof(clause86,conjecture,old(skc8,skc15) ).
fof(clause87,conjecture,dirty(skc8,skc15) ).
fof(clause88,conjecture,white(skc8,skc15) ).
fof(clause89,conjecture,chevy(skc8,skc15) ).
fof(clause90,conjecture,agent(skc8,skc11,skc15) ).
fof(clause91,conjecture,in(skc8,skc11,skc14) ).
fof(clause92,conjecture,of(skc8,skc13,skc14) ).
fof(clause93,conjecture,down(skc8,skc11,skc12) ).
fof(clause94,conjecture,ssSkP1(skc10,skc9,skc8) ).
