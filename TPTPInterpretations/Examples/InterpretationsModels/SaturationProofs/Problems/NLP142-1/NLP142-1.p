...
fof(clause69,conjecture,hollywood_placename(skc6,skc14) ).
fof(clause70,conjecture,placename(skc6,skc14) ).
fof(clause71,conjecture,street(skc6,skc12) ).
fof(clause72,conjecture,lonely(skc6,skc12) ).
fof(clause73,conjecture,two(skc6,skc7) ).
fof(clause74,conjecture,group(skc6,skc7) ).
fof(clause75,conjecture,barrel(skc6,skc11) ).
fof(clause76,conjecture,present(skc6,skc11) ).
fof(clause77,conjecture,event(skc6,skc11) ).
fof(clause78,conjecture,old(skc6,skc13) ).
fof(clause79,conjecture,dirty(skc6,skc13) ).
fof(clause80,conjecture,white(skc6,skc13) ).
fof(clause81,conjecture,chevy(skc6,skc13) ).
fof(clause82,conjecture,city(skc6,skc13) ).
fof(clause83,conjecture,of(skc6,skc14,skc13) ).
fof(clause84,conjecture,down(skc6,skc11,skc12) ).
fof(clause85,conjecture,in(skc6,skc11,skc13) ).
fof(clause86,conjecture,agent(skc6,skc11,skc13) ).
