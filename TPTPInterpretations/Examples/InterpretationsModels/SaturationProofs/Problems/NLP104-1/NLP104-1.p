...
fof(clause36,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc1,U) | ~ in(skc1,V,U) | ~ customer(skc1,V) | human_person(skc1,skf7(W)) ) ).
...
fof(clause41,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc1,U) | ~ in(skc1,V,U) | ~ customer(skc1,V) | coffee(skc1,skf6(W)) ) ).
...
fof(clause47,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc1,U) | ~ in(skc1,V,U) | ~ customer(skc1,V) | patient(skc1,skf4(W),skf7(W)) ) ).
fof(clause48,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc1,U) | ~ in(skc1,V,U) | ~ customer(skc1,V) | agent(skc1,skf5(W),skf7(W)) ) ).
fof(clause49,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc1,U) | ~ in(skc1,V,U) | ~ customer(skc1,V) | patient(skc1,skf5(W),skf6(W)) ) ).
