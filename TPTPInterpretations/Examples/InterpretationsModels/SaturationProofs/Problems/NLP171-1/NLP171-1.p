...
fof(clause75,conjecture,street(skc9,skc16) ).
fof(clause76,conjecture,lonely(skc9,skc16) ).
fof(clause77,conjecture,hollywood_placename(skc9,skc17) ).
fof(clause78,conjecture,placename(skc9,skc17) ).
fof(clause79,conjecture,barrel(skc9,skc15) ).
fof(clause80,conjecture,present(skc9,skc15) ).
fof(clause81,conjecture,event(skc9,skc15) ).
fof(clause82,conjecture,old(skc9,skc19) ).
fof(clause83,conjecture,dirty(skc9,skc19) ).
fof(clause84,conjecture,white(skc9,skc19) ).
fof(clause85,conjecture,chevy(skc9,skc19) ).
fof(clause86,conjecture,frontseat(skc9,skc19) ).
...
fof(clause91,conjecture,in(skc9,skc15,skc18) ).
fof(clause92,conjecture,of(skc9,skc17,skc18) ).
fof(clause93,conjecture,down(skc9,skc15,skc16) ).
fof(clause94,conjecture,agent(skc9,skc15,skc19) ).
...
fof(clause101,conjecture,! [U] : ! [V] : ( ~ member(skc9,U,skc14) | in(skc9,skf7(V),skc19) ) ).
