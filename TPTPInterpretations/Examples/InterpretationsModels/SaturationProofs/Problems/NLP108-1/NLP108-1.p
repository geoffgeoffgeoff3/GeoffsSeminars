...
fof(clause37,conjecture,restaurant(skc5,skc8) ).
fof(clause38,conjecture,human_person(skc5,skc7) ).
fof(clause39,conjecture,drink(skc5,skc6) ).
fof(clause40,conjecture,nonreflexive(skc5,skc6) ).
fof(clause41,conjecture,past(skc5,skc6) ).
fof(clause42,conjecture,event(skc5,skc6) ).
fof(clause43,conjecture,agent(skc5,skc6,skc7) ).
fof(clause44,conjecture,patient(skc5,skc6,skc10) ).
