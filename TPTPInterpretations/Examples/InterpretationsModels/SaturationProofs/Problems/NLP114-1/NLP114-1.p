...
fof(clause4,conjecture,ssSkC0 | street(skc17,skc20) ).
fof(clause5,conjecture,ssSkC0 | lonely(skc17,skc20) ).
fof(clause6,conjecture,ssSkC0 | placename(skc17,skc21) ).
fof(clause7,conjecture,ssSkC0 | hollywood_placename(skc17,skc21) ).
fof(clause8,conjecture,ssSkC0 | event(skc17,skc18) ).
fof(clause9,conjecture,ssSkC0 | present(skc17,skc18) ).
fof(clause10,conjecture,ssSkC0 | barrel(skc17,skc18) ).
fof(clause11,conjecture,ssSkC0 | old(skc17,skc19) ).
fof(clause12,conjecture,ssSkC0 | dirty(skc17,skc19) ).
fof(clause13,conjecture,ssSkC0 | white(skc17,skc19) ).
fof(clause14,conjecture,ssSkC0 | chevy(skc17,skc19) ).
...
fof(clause27,conjecture,ssSkC0 | down(skc17,skc18,skc20) ).
fof(clause28,conjecture,ssSkC0 | in(skc17,skc18,skc20) ).
fof(clause29,conjecture,ssSkC0 | of(skc17,skc21,skc20) ).
fof(clause30,conjecture,ssSkC0 | agent(skc17,skc18,skc19) ).
...
fof(clause36,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ( ~ city(U,V) | ~ street(U,V) | ~ lonely(U,V) | ~ down(U,W,V) | ~ in(U,W,V) | ~ placename(U,X) | ~ hollywood_placename(U,X) | ~ of(U,X,V) | ~ event(U,W) | ~ present(U,W) | ~ barrel(U,W) | ~ agent(U,W,Y) | ~ old(U,Y) | ~ dirty(U,Y) | ~ white(U,Y) | ~ chevy(U,Y) | ~ actual_world(U) | ~ ssSkC0 ) ).
