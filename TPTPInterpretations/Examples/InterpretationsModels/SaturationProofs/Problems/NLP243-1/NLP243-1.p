...
fof(clause73,conjecture,forename(skc14,skc28) ).
fof(clause74,conjecture,jules_forename(skc14,skc28) ).
fof(clause75,conjecture,man(skc14,skc27) ).
fof(clause76,conjecture,event(skc15,skc24) ).
fof(clause77,conjecture,jules_forename(skc14,skc23) ).
fof(clause78,conjecture,forename(skc14,skc23) ).
fof(clause79,conjecture,present(skc15,skc24) ).
fof(clause80,conjecture,smoke(skc15,skc24) ).
fof(clause81,conjecture,man(skc14,skc22) ).
fof(clause82,conjecture,vincent_forename(skc14,skc21) ).
fof(clause83,conjecture,forename(skc14,skc21) ).
fof(clause84,conjecture,think_believe_consider(skc14,skc20) ).
fof(clause85,conjecture,present(skc14,skc20) ).
fof(clause86,conjecture,event(skc14,skc20) ).
fof(clause87,conjecture,man(skc14,skc18) ).
fof(clause88,conjecture,forename(skc14,skc17) ).
fof(clause89,conjecture,vincent_forename(skc14,skc17) ).
fof(clause90,conjecture,event(skc14,skc16) ).
fof(clause91,conjecture,present(skc14,skc16) ).
fof(clause92,conjecture,think_believe_consider(skc14,skc16) ).
fof(clause93,conjecture,proposition(skc14,skc19) ).
fof(clause94,conjecture,accessible_world(skc14,skc19) ).
fof(clause95,conjecture,accessible_world(skc14,skc15) ).
fof(clause96,conjecture,proposition(skc14,skc15) ).
fof(clause97,conjecture,state(skc14,skc26) ).
fof(clause98,conjecture,of(skc14,skc28,skc27) ).
fof(clause99,conjecture,of(skc14,skc23,skc22) ).
fof(clause100,conjecture,agent(skc15,skc24,skc22) ).
fof(clause101,conjecture,agent(skc14,skc20,skc22) ).
fof(clause102,conjecture,of(skc14,skc21,skc22) ).
fof(clause103,conjecture,theme(skc14,skc20,skc19) ).
fof(clause104,conjecture,of(skc14,skc17,skc18) ).
fof(clause105,conjecture,agent(skc14,skc16,skc18) ).
fof(clause106,conjecture,theme(skc14,skc16,skc15) ).
fof(clause107,conjecture,be(skc14,skc26,skc27,skc27) ).
fof(clause108,conjecture,! [U] : ! [V] : ( ~ man(skc19,U) | smoke(skc19,skf1(V)) ) ).
fof(clause109,conjecture,! [U] : ! [V] : ( ~ man(skc19,U) | present(skc19,skf1(V)) ) ).
fof(clause110,conjecture,! [U] : ! [V] : ( ~ man(skc19,U) | event(skc19,skf1(V)) ) ).
fof(clause111,conjecture,! [U] : ( ~ man(skc19,U) | agent(skc19,skf1(U),U) ) ).
