...
fof(clause15,conjecture,~ ssSkC0 | event(skc11,skc12) ).
fof(clause16,conjecture,~ ssSkC0 | present(skc11,skc12) ).
fof(clause17,conjecture,~ ssSkC0 | barrel(skc11,skc12) ).
fof(clause18,conjecture,~ ssSkC0 | lonely(skc11,skc15) ).
fof(clause19,conjecture,~ ssSkC0 | street(skc11,skc15) ).
fof(clause20,conjecture,~ ssSkC0 | old(skc11,skc13) ).
fof(clause21,conjecture,~ ssSkC0 | dirty(skc11,skc13) ).
fof(clause22,conjecture,~ ssSkC0 | white(skc11,skc13) ).
fof(clause23,conjecture,~ ssSkC0 | chevy(skc11,skc13) ).
fof(clause24,conjecture,~ ssSkC0 | city(skc11,skc13) ).
fof(clause25,conjecture,~ ssSkC0 | hollywood_placename(skc11,skc14) ).
fof(clause26,conjecture,~ ssSkC0 | placename(skc11,skc14) ).
...
fof(clause31,conjecture,~ ssSkC0 | down(skc11,skc12,skc15) ).
fof(clause32,conjecture,~ ssSkC0 | in(skc11,skc12,skc13) ).
fof(clause33,conjecture,~ ssSkC0 | agent(skc11,skc12,skc13) ).
fof(clause34,conjecture,~ ssSkC0 | of(skc11,skc14,skc13) ).
fof(clause35,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ( ~ event(U,V) | ~ present(U,V) | ~ barrel(U,V) | ~ down(U,V,W) | ~ lonely(U,W) | ~ street(U,W) | ~ in(U,V,X) | ~ agent(U,V,X) | ~ old(U,X) | ~ dirty(U,X) | ~ white(U,X) | ~ chevy(U,X) | ~ city(U,X) | ~ of(U,Y,X) | ~ hollywood_placename(U,Y) | ~ placename(U,Y) | ~ actual_world(U) | ssSkC0 ) ).
