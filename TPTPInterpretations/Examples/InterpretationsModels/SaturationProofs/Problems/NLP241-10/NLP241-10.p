...
fof(clause72,conjecture,actual_world(skc15) = true ).
fof(clause73,conjecture,man(skc15,skc29) = true ).
fof(clause74,conjecture,forename(skc15,skc28) = true ).
fof(clause75,conjecture,vincent_forename(skc15,skc28) = true ).
fof(clause76,conjecture,event(skc15,skc27) = true ).
fof(clause77,conjecture,present(skc15,skc27) = true ).
...
fof(clause81,conjecture,man(skc15,skc24) = true ).
fof(clause82,conjecture,event(skc16,skc22) = true ).
fof(clause83,conjecture,man(skc15,skc21) = true ).
fof(clause84,conjecture,present(skc16,skc22) = true ).
fof(clause85,conjecture,smoke(skc16,skc22) = true ).
fof(clause86,conjecture,man(skc15,skc19) = true ).
fof(clause87,conjecture,think_believe_consider(skc15,skc17) = true ).
fof(clause88,conjecture,present(skc15,skc17) = true ).
fof(clause89,conjecture,event(skc15,skc17) = true ).
...
fof(clause93,conjecture,jules_forename(skc15,skc20) = true ).
fof(clause94,conjecture,proposition(skc15,skc16) = true ).
fof(clause95,conjecture,accessible_world(skc15,skc16) = true ).
fof(clause96,conjecture,state(skc15,skc23) = true ).
fof(clause97,conjecture,accessible_world(skc15,skc26) = true ).
fof(clause98,conjecture,proposition(skc15,skc26) = true ).
fof(clause99,conjecture,of(skc15,skc28,skc29) = true ).
fof(clause100,conjecture,agent(skc15,skc27,skc29) = true ).
fof(clause101,conjecture,theme(skc15,skc27,skc26) = true ).
fof(clause102,conjecture,of(skc15,skc25,skc24) = true ).
fof(clause103,conjecture,of(skc15,skc20,skc21) = true ).
fof(clause104,conjecture,agent(skc16,skc22,skc21) = true ).
fof(clause105,conjecture,of(skc15,skc18,skc19) = true ).
fof(clause106,conjecture,agent(skc15,skc17,skc19) = true ).
fof(clause107,conjecture,theme(skc15,skc17,skc16) = true ).
fof(clause108,conjecture,be(skc15,skc23,skc24,skc24) = true ).
fof(clause109,conjecture,! [U] : ! [V] : ifeq2(man(skc26,U),true,smoke(skc26,skf1(V)),true) = true ).
fof(clause110,conjecture,! [U] : ! [V] : ifeq2(man(skc26,U),true,present(skc26,skf1(V)),true) = true ).
fof(clause111,conjecture,! [U] : ! [V] : ifeq2(man(skc26,U),true,event(skc26,skf1(V)),true) = true ).
fof(clause112,conjecture,! [U] : ifeq2(man(skc26,U),true,agent(skc26,skf1(U),U),true) = true ).
