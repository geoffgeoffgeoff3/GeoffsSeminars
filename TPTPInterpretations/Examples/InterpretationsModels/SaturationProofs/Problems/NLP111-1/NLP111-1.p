...
fof(clause36,conjecture,restaurant(skc5,skc8) ).
fof(clause37,conjecture,human_person(skc5,skc7) ).
fof(clause38,conjecture,drink(skc5,skc6) ).
fof(clause39,conjecture,nonreflexive(skc5,skc6) ).
fof(clause40,conjecture,past(skc5,skc6) ).
fof(clause41,conjecture,event(skc5,skc6) ).
fof(clause42,conjecture,coffee(skc5,skc10) ).
fof(clause43,conjecture,patient(skc5,skc6,skc10) ).
fof(clause44,conjecture,agent(skc5,skc6,skc7) ).
fof(clause45,conjecture,! [U] : ! [V] : ( ~ in(skc5,U,skc8) | ~ customer(skc5,U) | see(skc5,skf1(V)) ) ).
fof(clause46,conjecture,! [U] : ! [V] : ( ~ in(skc5,U,skc8) | ~ customer(skc5,U) | nonreflexive(skc5,skf1(V)) ) ).
fof(clause47,conjecture,! [U] : ! [V] : ( ~ in(skc5,U,skc8) | ~ customer(skc5,U) | past(skc5,skf1(V)) ) ).
fof(clause48,conjecture,! [U] : ! [V] : ( ~ in(skc5,U,skc8) | ~ customer(skc5,U) | event(skc5,skf1(V)) ) ).
fof(clause49,conjecture,! [U] : ! [V] : ( ~ in(skc5,U,skc8) | ~ customer(skc5,U) | patient(skc5,skf1(V),skc7) ) ).
fof(clause50,conjecture,! [U] : ( ~ in(skc5,U,skc8) | ~ customer(skc5,U) | agent(skc5,skf1(U),U) ) ).
