...
fof(clause73,conjecture,event(skc14,skc26) ).
fof(clause74,conjecture,jules_forename(skc13,skc24) ).
fof(clause75,conjecture,forename(skc13,skc24) ).
fof(clause76,conjecture,jules_forename(skc13,skc25) ).
fof(clause77,conjecture,forename(skc13,skc25) ).
fof(clause78,conjecture,present(skc14,skc26) ).
fof(clause79,conjecture,smoke(skc14,skc26) ).
fof(clause80,conjecture,man(skc13,skc23) ).
fof(clause81,conjecture,forename(skc13,skc20) ).
fof(clause82,conjecture,vincent_forename(skc13,skc20) ).
fof(clause83,conjecture,man(skc13,skc19) ).
fof(clause84,conjecture,forename(skc13,skc18) ).
fof(clause85,conjecture,vincent_forename(skc13,skc18) ).
fof(clause86,conjecture,event(skc13,skc17) ).
fof(clause87,conjecture,present(skc13,skc17) ).
fof(clause88,conjecture,think_believe_consider(skc13,skc17) ).
fof(clause89,conjecture,think_believe_consider(skc13,skc15) ).
fof(clause90,conjecture,present(skc13,skc15) ).
fof(clause91,conjecture,event(skc13,skc15) ).
fof(clause92,conjecture,accessible_world(skc13,skc16) ).
fof(clause93,conjecture,proposition(skc13,skc16) ).
fof(clause94,conjecture,proposition(skc13,skc14) ).
fof(clause95,conjecture,accessible_world(skc13,skc14) ).
fof(clause96,conjecture,state(skc13,skc22) ).
fof(clause97,conjecture,of(skc13,skc25,skc23) ).
fof(clause98,conjecture,of(skc13,skc24,skc23) ).
fof(clause99,conjecture,agent(skc14,skc26,skc23) ).
fof(clause100,conjecture,of(skc13,skc20,skc19) ).
fof(clause101,conjecture,of(skc13,skc18,skc19) ).
fof(clause102,conjecture,agent(skc13,skc17,skc19) ).
fof(clause103,conjecture,agent(skc13,skc15,skc19) ).
fof(clause104,conjecture,theme(skc13,skc17,skc16) ).
fof(clause105,conjecture,theme(skc13,skc15,skc14) ).
fof(clause106,conjecture,be(skc13,skc22,skc23,skc23) ).
fof(clause107,conjecture,! [U] : ! [V] : ( ~ man(skc16,U) | smoke(skc16,skf1(V)) ) ).
fof(clause108,conjecture,! [U] : ! [V] : ( ~ man(skc16,U) | present(skc16,skf1(V)) ) ).
fof(clause109,conjecture,! [U] : ! [V] : ( ~ man(skc16,U) | event(skc16,skf1(V)) ) ).
fof(clause110,conjecture,! [U] : ( ~ man(skc16,U) | agent(skc16,skf1(U),U) ) ).
