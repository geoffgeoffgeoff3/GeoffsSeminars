...
fof(problem_10_148,conjecture,topological_space(cx,ct) ).
fof(problem_10_149,conjecture,subset_sets(a,cx) ).
fof(problem_10_150,conjecture,~ equal_sets(intersection_of_sets(interior(a,cx,ct),boundary(a,cx,ct)),empty_set) ).
