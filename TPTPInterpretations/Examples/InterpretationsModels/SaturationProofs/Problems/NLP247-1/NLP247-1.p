...
fof(clause76,conjecture,event(skc15,skc25) ).
fof(clause77,conjecture,man(skc14,skc24) ).
fof(clause78,conjecture,present(skc15,skc25) ).
fof(clause79,conjecture,smoke(skc15,skc25) ).
fof(clause80,conjecture,vincent_forename(skc14,skc21) ).
fof(clause81,conjecture,forename(skc14,skc21) ).
fof(clause82,conjecture,man(skc14,skc20) ).
fof(clause83,conjecture,vincent_forename(skc14,skc19) ).
fof(clause84,conjecture,forename(skc14,skc19) ).
fof(clause85,conjecture,think_believe_consider(skc14,skc18) ).
fof(clause86,conjecture,present(skc14,skc18) ).
fof(clause87,conjecture,event(skc14,skc18) ).
...
fof(clause91,conjecture,proposition(skc14,skc17) ).
fof(clause92,conjecture,accessible_world(skc14,skc17) ).
fof(clause93,conjecture,accessible_world(skc14,skc15) ).
fof(clause94,conjecture,proposition(skc14,skc15) ).
fof(clause95,conjecture,forename(skc14,skc23) ).
fof(clause96,conjecture,jules_forename(skc14,skc23) ).
fof(clause97,conjecture,state(skc14,skc26) ).
fof(clause98,conjecture,of(skc14,skc28,skc27) ).
fof(clause99,conjecture,of(skc14,skc23,skc24) ).
fof(clause100,conjecture,agent(skc15,skc25,skc24) ).
fof(clause101,conjecture,of(skc14,skc21,skc20) ).
fof(clause102,conjecture,agent(skc14,skc16,skc20) ).
fof(clause103,conjecture,agent(skc14,skc18,skc20) ).
fof(clause104,conjecture,of(skc14,skc19,skc20) ).
fof(clause105,conjecture,theme(skc14,skc18,skc17) ).
fof(clause106,conjecture,theme(skc14,skc16,skc15) ).
fof(clause107,conjecture,be(skc14,skc26,skc27,skc27) ).
fof(clause108,conjecture,! [U] : ! [V] : ( ~ man(skc17,U) | smoke(skc17,skf1(V)) ) ).
fof(clause109,conjecture,! [U] : ! [V] : ( ~ man(skc17,U) | present(skc17,skf1(V)) ) ).
fof(clause110,conjecture,! [U] : ! [V] : ( ~ man(skc17,U) | event(skc17,skf1(V)) ) ).
fof(clause111,conjecture,! [U] : ( ~ man(skc17,U) | agent(skc17,skf1(U),U) ) ).
