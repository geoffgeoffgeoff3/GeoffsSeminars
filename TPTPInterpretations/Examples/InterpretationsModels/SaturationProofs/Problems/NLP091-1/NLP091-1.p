...
fof(clause93,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ( ~ revenge(U,V) | ~ of(U,W,V) | ~ event(U,W) | ~ present(U,W) | ~ nonreflexive(U,W) | ~ scream(U,W) | ~ agent(U,W,X) | ~ group(U,X) | ~ six(U,X) | ~ male(U,X) | ~ cannon(U,Y) | ~ ssSkP0(Y,Z,X,U) | ~ of(U,Y,Z) | ~ man(U,Z) | ~ male(U,Z) | ~ patient(U,W,X1) | ~ cry(U,X1) | ~ actual_world(U) | member(U,skf10(U,X),X) ) ).
fof(clause94,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ( ~ revenge(U,V) | ~ of(U,W,V) | ~ event(U,W) | ~ present(U,W) | ~ nonreflexive(U,W) | ~ scream(U,W) | ~ agent(U,W,X) | ~ shot(U,skf10(U,Y)) | ~ group(U,X) | ~ six(U,X) | ~ male(U,X) | ~ cannon(U,Z) | ~ ssSkP0(Z,X1,X,U) | ~ of(U,Z,X1) | ~ man(U,X1) | ~ male(U,X1) | ~ patient(U,W,X2) | ~ cry(U,X2) | ~ actual_world(U) ) ).
