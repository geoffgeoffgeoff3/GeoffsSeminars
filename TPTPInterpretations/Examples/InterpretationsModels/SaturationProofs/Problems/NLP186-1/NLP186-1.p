...
fof(clause74,conjecture,placename(skc7,skc13) ).
fof(clause75,conjecture,hollywood_placename(skc7,skc13) ).
fof(clause76,conjecture,lonely(skc7,skc11) ).
fof(clause77,conjecture,street(skc7,skc11) ).
fof(clause78,conjecture,frontseat(skc7,skc9) ).
fof(clause79,conjecture,ssSkP0(skc8,skc7) ).
fof(clause80,conjecture,group(skc7,skc8) ).
fof(clause81,conjecture,two(skc7,skc8) ).
fof(clause82,conjecture,event(skc7,skc10) ).
fof(clause83,conjecture,present(skc7,skc10) ).
fof(clause84,conjecture,barrel(skc7,skc10) ).
fof(clause85,conjecture,city(skc7,skc12) ).
fof(clause86,conjecture,chevy(skc7,skc12) ).
fof(clause87,conjecture,white(skc7,skc12) ).
fof(clause88,conjecture,dirty(skc7,skc12) ).
fof(clause89,conjecture,old(skc7,skc12) ).
fof(clause90,conjecture,of(skc7,skc13,skc12) ).
fof(clause91,conjecture,down(skc7,skc10,skc11) ).
fof(clause92,conjecture,ssSkP1(skc9,skc8,skc7) ).
fof(clause93,conjecture,agent(skc7,skc10,skc12) ).
fof(clause94,conjecture,in(skc7,skc10,skc12) ).
