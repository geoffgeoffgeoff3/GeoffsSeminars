...
fof(axiom_4,conjecture,! [X] : ! [Y] : ! [Z] : ( ( rrx3(X,Y) & rrx3(X,Z) ) => Y = Z ) ).
fof(axiom_5,conjecture,! [X] : ! [Y] : ! [Z] : ( ( rrx3a(X,Y) & rrx3a(X,Z) ) => Y = Z ) ).
fof(axiom_6,conjecture,! [X] : ! [Y] : ! [Z] : ( ( rrx4(X,Y) & rrx4(X,Z) ) => Y = Z ) ).
fof(axiom_7,conjecture,! [X] : ! [Y] : ! [Z] : ( ( rrx4a(X,Y) & rrx4a(X,Z) ) => Y = Z ) ).
fof(axiom_8,conjecture,cSatisfiable(i2003_11_14_17_15_19316) ).
fof(axiom_9,conjecture,! [X] : ! [Y] : ( rrx3a(X,Y) => rrxa(X,Y) ) ).
fof(axiom_10,conjecture,! [X] : ! [Y] : ( rrx3(X,Y) => rrx1(X,Y) ) ).
fof(axiom_11,conjecture,! [X] : ! [Y] : ( rrx4a(X,Y) => rrxa(X,Y) ) ).
fof(axiom_12,conjecture,! [X] : ! [Y] : ( rrx3(X,Y) => rrx(X,Y) ) ).
fof(axiom_13,conjecture,! [X] : ! [Y] : ( rrx4(X,Y) => rrx2(X,Y) ) ).
fof(axiom_14,conjecture,! [X] : ! [Y] : ( rrx4a(X,Y) => rrx2a(X,Y) ) ).
fof(axiom_15,conjecture,! [X] : ! [Y] : ( rrx4(X,Y) => rrx(X,Y) ) ).
fof(axiom_16,conjecture,! [X] : ! [Y] : ( rrx3a(X,Y) => rrx1a(X,Y) ) ).
