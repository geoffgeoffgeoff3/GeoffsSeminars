...
fof(clause3,conjecture,ssSkC0 | city(skc15,skc18) ).
fof(clause4,conjecture,ssSkC0 | chevy(skc15,skc18) ).
fof(clause5,conjecture,ssSkC0 | white(skc15,skc18) ).
fof(clause6,conjecture,ssSkC0 | dirty(skc15,skc18) ).
fof(clause7,conjecture,ssSkC0 | old(skc15,skc18) ).
fof(clause8,conjecture,ssSkC0 | placename(skc15,skc19) ).
fof(clause9,conjecture,ssSkC0 | hollywood_placename(skc15,skc19) ).
fof(clause10,conjecture,ssSkC0 | event(skc15,skc16) ).
fof(clause11,conjecture,ssSkC0 | present(skc15,skc16) ).
fof(clause12,conjecture,ssSkC0 | barrel(skc15,skc16) ).
fof(clause13,conjecture,ssSkC0 | lonely(skc15,skc17) ).
fof(clause14,conjecture,ssSkC0 | street(skc15,skc17) ).
...
fof(clause27,conjecture,ssSkC0 | agent(skc15,skc16,skc18) ).
fof(clause28,conjecture,ssSkC0 | in(skc15,skc16,skc18) ).
fof(clause29,conjecture,ssSkC0 | of(skc15,skc19,skc18) ).
fof(clause30,conjecture,ssSkC0 | down(skc15,skc16,skc17) ).
