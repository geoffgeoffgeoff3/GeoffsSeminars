...
fof(clause69,conjecture,chevy(skc5,skc9) ).
fof(clause70,conjecture,placename(skc5,skc8) ).
fof(clause71,conjecture,hollywood_placename(skc5,skc8) ).
fof(clause72,conjecture,city(skc5,skc7) ).
fof(clause73,conjecture,street(skc5,skc7) ).
fof(clause74,conjecture,lonely(skc5,skc7) ).
fof(clause75,conjecture,white(skc5,skc9) ).
fof(clause76,conjecture,dirty(skc5,skc9) ).
fof(clause77,conjecture,old(skc5,skc9) ).
fof(clause78,conjecture,barrel(skc5,skc6) ).
fof(clause79,conjecture,present(skc5,skc6) ).
fof(clause80,conjecture,event(skc5,skc6) ).
fof(clause81,conjecture,of(skc5,skc8,skc7) ).
fof(clause82,conjecture,down(skc5,skc6,skc7) ).
fof(clause83,conjecture,in(skc5,skc6,skc7) ).
fof(clause84,conjecture,agent(skc5,skc6,skc9) ).
...
fof(clause87,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ( ~ event(U,V) | ~ present(U,V) | ~ barrel(U,V) | ~ agent(U,V,W) | ~ old(U,W) | ~ dirty(U,W) | ~ white(U,W) | ~ chevy(U,W) | ~ in(U,V,X) | ~ down(U,V,X) | ~ lonely(U,X) | ~ street(U,X) | ~ city(U,X) | ~ of(U,Y,X) | ~ hollywood_placename(U,Y) | ~ placename(U,Y) | ~ group(U,Z) | ~ two(U,Z) | ~ ssSkP0(Z,U) | ~ actual_world(U) | member(U,skf5(U,Z),Z) ) ).
fof(clause88,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ( ~ event(U,V) | ~ present(U,V) | ~ barrel(U,V) | ~ agent(U,V,W) | ~ old(U,W) | ~ dirty(U,W) | ~ white(U,W) | ~ chevy(U,W) | ~ in(U,V,X) | ~ down(U,V,X) | ~ lonely(U,X) | ~ street(U,X) | ~ city(U,X) | ~ of(U,Y,X) | ~ hollywood_placename(U,Y) | ~ placename(U,Y) | ~ young(U,skf5(U,Z)) | ~ fellow(U,skf5(U,Z)) | ~ group(U,X1) | ~ two(U,X1) | ~ ssSkP0(X1,U) | ~ actual_world(U) ) ).
