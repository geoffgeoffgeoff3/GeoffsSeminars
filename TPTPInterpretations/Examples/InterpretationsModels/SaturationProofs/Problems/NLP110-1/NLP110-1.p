...
fof(clause35,conjecture,actual_world(skc4) ).
fof(clause36,conjecture,coffee(skc4,skc8) ).
fof(clause37,conjecture,human_person(skc4,skc6) ).
fof(clause38,conjecture,event(skc4,skc5) ).
fof(clause39,conjecture,past(skc4,skc5) ).
fof(clause40,conjecture,nonreflexive(skc4,skc5) ).
fof(clause41,conjecture,drink(skc4,skc5) ).
fof(clause42,conjecture,agent(skc4,skc5,skc6) ).
fof(clause43,conjecture,patient(skc4,skc5,skc8) ).
fof(clause44,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc4,U) | ~ in(skc4,V,U) | ~ customer(skc4,V) | event(skc4,skf1(W)) ) ).
fof(clause45,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc4,U) | ~ in(skc4,V,U) | ~ customer(skc4,V) | past(skc4,skf1(W)) ) ).
fof(clause46,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc4,U) | ~ in(skc4,V,U) | ~ customer(skc4,V) | nonreflexive(skc4,skf1(W)) ) ).
fof(clause47,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc4,U) | ~ in(skc4,V,U) | ~ customer(skc4,V) | see(skc4,skf1(W)) ) ).
fof(clause48,conjecture,! [U] : ! [V] : ( ~ restaurant(skc4,U) | ~ in(skc4,V,U) | ~ customer(skc4,V) | agent(skc4,skf1(V),V) ) ).
fof(clause49,conjecture,! [U] : ! [V] : ! [W] : ( ~ restaurant(skc4,U) | ~ in(skc4,V,U) | ~ customer(skc4,V) | patient(skc4,skf1(W),skc6) ) ).
