...
fof(clause123,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ! [X3] : ! [X4] : ! [X5] : ( ~ group(U,V) | ~ ssSkP2(W,V,U) | ~ ssSkP0(W,U) | ~ group(U,W) | ~ two(U,W) | ~ event(U,X) | ~ present(U,X) | ~ barrel(U,X) | ~ behind(U,Y,Z) | ~ agent(U,X,Z) | ~ old(U,Z) | ~ dirty(U,Z) | ~ white(U,Z) | ~ chevy(U,Z) | ~ wheel(U,Z) | ~ ssSkP1(X1,W,U) | ~ in(U,X,X1) | ~ down(U,X,X1) | ~ lonely(U,X1) | ~ street(U,X1) | ~ city(U,X1) | ~ frontseat(U,X1) | ~ of(U,X2,X1) | ~ hollywood_placename(U,X2) | ~ placename(U,X2) | ~ state(U,X3) | ~ jules_forename(U,X4) | ~ forename(U,X4) | ~ be(U,X3,X5,Y) | ~ man(U,X5) | ~ of(U,X4,X5) | ~ actual_world(U) | member(U,skf11(U,V),V) ) ).
fof(clause124,conjecture,! [U] : ! [V] : ! [W] : ! [X] : ! [Y] : ! [Z] : ! [X1] : ! [X2] : ! [X3] : ! [X4] : ! [X5] : ! [X6] : ( ~ group(U,V) | ~ cheap(U,skf11(U,W)) | ~ black(U,skf11(U,W)) | ~ coat(U,skf11(U,W)) | ~ ssSkP2(X,V,U) | ~ ssSkP0(X,U) | ~ group(U,X) | ~ two(U,X) | ~ event(U,Y) | ~ present(U,Y) | ~ barrel(U,Y) | ~ behind(U,Z,X1) | ~ agent(U,Y,X1) | ~ old(U,X1) | ~ dirty(U,X1) | ~ white(U,X1) | ~ chevy(U,X1) | ~ wheel(U,X1) | ~ ssSkP1(X2,X,U) | ~ in(U,Y,X2) | ~ down(U,Y,X2) | ~ lonely(U,X2) | ~ street(U,X2) | ~ city(U,X2) | ~ frontseat(U,X2) | ~ of(U,X3,X2) | ~ hollywood_placename(U,X3) | ~ placename(U,X3) | ~ state(U,X4) | ~ jules_forename(U,X5) | ~ forename(U,X5) | ~ be(U,X4,X6,Z) | ~ man(U,X6) | ~ of(U,X5,X6) | ~ actual_world(U) ) ).
