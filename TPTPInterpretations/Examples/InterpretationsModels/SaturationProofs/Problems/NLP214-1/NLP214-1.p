...
fof(clause78,conjecture,actual_world(skc8) ).
fof(clause79,conjecture,hollywood_placename(skc8,skc14) ).
fof(clause80,conjecture,placename(skc8,skc14) ).
fof(clause81,conjecture,lonely(skc8,skc13) ).
fof(clause82,conjecture,street(skc8,skc13) ).
fof(clause83,conjecture,city(skc8,skc13) ).
fof(clause84,conjecture,frontseat(skc8,skc11) ).
fof(clause85,conjecture,ssSkP0(skc10,skc8) ).
fof(clause86,conjecture,group(skc8,skc10) ).
fof(clause87,conjecture,two(skc8,skc10) ).
fof(clause88,conjecture,group(skc8,skc9) ).
fof(clause89,conjecture,old(skc8,skc15) ).
fof(clause90,conjecture,dirty(skc8,skc15) ).
fof(clause91,conjecture,white(skc8,skc15) ).
fof(clause92,conjecture,chevy(skc8,skc15) ).
fof(clause93,conjecture,event(skc8,skc12) ).
fof(clause94,conjecture,present(skc8,skc12) ).
fof(clause95,conjecture,barrel(skc8,skc12) ).
fof(clause96,conjecture,agent(skc8,skc12,skc15) ).
fof(clause97,conjecture,of(skc8,skc14,skc13) ).
fof(clause98,conjecture,in(skc8,skc12,skc13) ).
fof(clause99,conjecture,down(skc8,skc12,skc13) ).
fof(clause100,conjecture,ssSkP1(skc11,skc10,skc8) ).
fof(clause101,conjecture,ssSkP2(skc10,skc9,skc8) ).
fof(clause102,conjecture,! [U] : ( ~ member(skc8,U,skc9) | cheap(skc8,U) ) ).
fof(clause103,conjecture,! [U] : ( ~ member(skc8,U,skc9) | black(skc8,U) ) ).
fof(clause104,conjecture,! [U] : ( ~ member(skc8,U,skc9) | coat(skc8,U) ) ).
